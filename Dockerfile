...
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH} go build \
    -trimpath \
    -o /app/legacy-entitlement-backfill \
    ./cmd/legacy-entitlement-backfill
...
COPY --from=backend-builder --chown=sub2api:sub2api /app/legacy-entitlement-backfill /app/legacy-entitlement-backfill
