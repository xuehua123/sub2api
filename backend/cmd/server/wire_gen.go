...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	lobeHubOIDCService := service.ProvideLobeHubOIDCService(settingService, userService, lobeHubOIDCStateStore, settingService)
	lobeHubLaunchService := service.ProvideLobeHubLaunchService(settingService, apiKeyService, lobeHubLaunchStateStore, lobeHubOIDCService)
	lobeHubSSOService := service.ProvideLobeHubSSOService(settingService, userService, apiKeyService, lobeHubOIDCStateStore, settingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, lobeHubHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, idempotencyCoordinator, idempotencyCleanupService)
