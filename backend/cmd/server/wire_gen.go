...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	paymentService := service.NewPaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, referralRewardService, referralRefundService, affiliateService)
