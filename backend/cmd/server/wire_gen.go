...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	referralAdminRelationRepo := repository.ProvideReferralAdminRelationRepository(client)
	referralAdminCommissionRepo := repository.ProvideReferralAdminCommissionRepository(client)
	...
	referralAdminService := service.NewReferralAdminService(referralService, referralAdminRelationRepo, referralAdminCommissionRepo, client, referralSettlementService)
	...
	referralCenterRelationRepo := repository.ProvideReferralCenterRelationRepository(client)
	referralCenterCommissionRepo := repository.ProvideReferralCenterCommissionRepository(client)
	referralCenterService := service.NewReferralCenterService(referralService, referralCenterRelationRepo, referralCenterCommissionRepo, referralSettlementService)
	referralHandler := handler.NewReferralHandler(referralService, referralCenterService, referralWithdrawalService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, referralHandler, lobeHubHandler, idempotencyCoordinator, idempotencyCleanupService)
