...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamConnectionService := service.ProvideUpstreamConnectionService(upstreamConnectionRepository, secretEncryptor, configConfig, proxyRepository, accountRepository, usageLogRepository, concurrencyService, leaderLockCache, db, accountTestService)
