...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	lobeHubUserPreferenceStore := repository.ProvideLobeHubUserPreferenceStore(client, db)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, lobeHubHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
