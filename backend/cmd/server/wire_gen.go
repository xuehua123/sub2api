...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, entitlementHandler, announcementHandler, supportIssueHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, handlerReferralHandler, lobeHubHandler, availableChannelHandler, modelPriceHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
