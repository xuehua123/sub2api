...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ChannelMonitorRequestTemplate, c.CommissionLedger, c.CommissionPayoutAccount,
		c.CommissionReward, c.CommissionWithdrawal, c.CommissionWithdrawalItem,
...
type (
	hooks struct {
		...
		ChannelMonitorHistory, ChannelMonitorRequestTemplate, CommissionLedger,
