...
func init() {
	...
	// apikeyDescAccessSource is the schema descriptor for access_source field.
	apikeyDescAccessSource := apikeyFields[5].Descriptor()
	// apikey.DefaultAccessSource holds the default value on creation for the access_source field.
	apikey.DefaultAccessSource = apikeyDescAccessSource.Default.(string)
	// apikey.AccessSourceValidator is a validator for the "access_source" field. It is called by the builders before save.
	apikey.AccessSourceValidator = apikeyDescAccessSource.Validators[0].(func(string) error)
	// apikeyDescAutoSwitchGroupEnabled is the schema descriptor for auto_switch_group_enabled field.
	apikeyDescAutoSwitchGroupEnabled := apikeyFields[6].Descriptor()
	...
	// groupDescBalanceEnabled is the schema descriptor for balance_enabled field.
	groupDescBalanceEnabled := groupFields[12].Descriptor()
	// group.DefaultBalanceEnabled holds the default value on creation for the balance_enabled field.
	group.DefaultBalanceEnabled = groupDescBalanceEnabled.Default.(bool)
	// groupDescSubscriptionEnabled is the schema descriptor for subscription_enabled field.
	groupDescSubscriptionEnabled := groupFields[13].Descriptor()
	...
	// groupDescPlanAutoGrantEnabled is the schema descriptor for plan_auto_grant_enabled field.
	groupDescPlanAutoGrantEnabled := groupFields[14].Descriptor()
	// group.DefaultPlanAutoGrantEnabled holds the default value on creation for the plan_auto_grant_enabled field.
	group.DefaultPlanAutoGrantEnabled = groupDescPlanAutoGrantEnabled.Default.(bool)
	...
	subscriptionplanDescAccessScope := subscriptionplanFields[8].Descriptor()
	...
	subscriptionplanDescOveragePolicy := subscriptionplanFields[13].Descriptor()
	...
	subscriptionplanDescFeatures := subscriptionplanFields[14].Descriptor()
	...
	subscriptionplanDescProductName := subscriptionplanFields[15].Descriptor()
	...
	upstreamconnectionDescCredentialHint := upstreamconnectionFields[7].Descriptor()
	...
	upstreamconnectionDescRemoteUserID := upstreamconnectionFields[8].Descriptor()
	...
	upstreamconnectionDescCapabilities := upstreamconnectionFields[10].Descriptor()
	...
	upstreamconnectionDescStatus := upstreamconnectionFields[11].Descriptor()
	...
	upstreamconnectionDescLastError := upstreamconnectionFields[12].Descriptor()
	...
	upstreamconnectionDescSyncEnabled := upstreamconnectionFields[13].Descriptor()
	...
	upstreamconnectionDescSyncIntervalSeconds := upstreamconnectionFields[14].Descriptor()
	...
	upstreamconnectionDescSyncFailures := upstreamconnectionFields[15].Descriptor()
	...
	upstreamconnectionDescVersion := upstreamconnectionFields[16].Descriptor()
	...
	upstreamconnectionDescWalletCurrency := upstreamconnectionFields[18].Descriptor()
	...
	upstreamconnectionDescWalletUnlimited := upstreamconnectionFields[20].Descriptor()
	...
	upstreamconnectionDescWalletSource := upstreamconnectionFields[21].Descriptor()
	...
	upstreamconnectionDescWalletReliability := upstreamconnectionFields[22].Descriptor()
	...
	upstreamconnectionDescWalletRaw := upstreamconnectionFields[23].Descriptor()
	...
	usagelogDescBillingSource := usagelogFields[32].Descriptor()
	...
	// userDescRestrictToAllowedGroups is the schema descriptor for restrict_to_allowed_groups field.
	userDescRestrictToAllowedGroups := userFields[8].Descriptor()
	// user.DefaultRestrictToAllowedGroups holds the default value on creation for the restrict_to_allowed_groups field.
	user.DefaultRestrictToAllowedGroups = userDescRestrictToAllowedGroups.Default.(bool)
	// userDescRestrictPublicGroups is the schema descriptor for restrict_public_groups field.
	userDescRestrictPublicGroups := userFields[9].Descriptor()
	...
	// userDescPaymentDisabled is the schema descriptor for payment_disabled field.
	userDescPaymentDisabled := userFields[10].Descriptor()
	// user.DefaultPaymentDisabled holds the default value on creation for the payment_disabled field.
	user.DefaultPaymentDisabled = userDescPaymentDisabled.Default.(bool)
	...
	userDescReferralEnabled := userFields[16].Descriptor()
