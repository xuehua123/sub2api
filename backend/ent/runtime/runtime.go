...
func init() {
	...
	groupDescBalanceEnabled := groupFields[11].Descriptor()
	...
	groupDescSubscriptionEnabled := groupFields[12].Descriptor()
	...
	groupDescPlanAutoGrantEnabled := groupFields[13].Descriptor()
