...
func (h *DashboardHandler) GetUsageTrend(c *gin.Context) {
	...
	trend, hit, err := h.getUsageTrendCached(c.Request.Context(), startTime, endTime, granularity, userID, apiKeyID, accountID, groupID, entitlementID, model, requestType, stream, nativeCompactionV2, billingType, upstreamModelMismatch)
	if err != nil {
...
func (h *DashboardHandler) GetModelStats(c *gin.Context) {
	...
	stats, hit, err := h.getModelStatsCached(c.Request.Context(), startTime, endTime, userID, apiKeyID, accountID, groupID, entitlementID, modelSource, requestType, stream, nativeCompactionV2, billingType, upstreamModelMismatch)
	if err != nil {
...
func (h *DashboardHandler) GetGroupStats(c *gin.Context) {
	...
	stats, hit, err := h.getGroupStatsCached(c.Request.Context(), startTime, endTime, userID, apiKeyID, accountID, groupID, entitlementID, requestType, stream, nativeCompactionV2, billingType, upstreamModelMismatch)
	if err != nil {
