...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		ConnectivityProbeAllowedOrigins:                        settings.ConnectivityProbeAllowedOrigins,
		ConnectivityProbeIPRPM:                                 settings.ConnectivityProbeIPRPM,
		ConnectivityProbeBurst:                                 settings.ConnectivityProbeBurst,
