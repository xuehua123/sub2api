...
func TestUserAvailableChannel_FieldWhitelist(t *testing.T) {
	...
	for _, key := range []string{"id", "name", "platform", "subscription_type", "rate_multiplier", "sort_order", "peak_rate_enabled", "peak_start", "peak_end", "peak_rate_multiplier", "is_exclusive"} {
