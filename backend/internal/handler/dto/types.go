...
type AdminUser struct {
	...
	// RestrictPublicGroups restricts public groups to AllowedGroups. It is
	// independent from User.RestrictToAllowedGroups (exclusive-only mode).
...
type UserEntitlement struct {
	AutoAdvanceMonthly     bool                                   `json:"auto_advance_monthly"`
	LastSeenEventID        int64                                  `json:"last_seen_event_id"`
	LatestRenewal          *service.SubscriptionEntitlementEvent  `json:"latest_renewal,omitempty"`
	LatestCycle            *service.SubscriptionEntitlementEvent  `json:"latest_cycle,omitempty"`
	MonthlyCyclePreview    service.EntitlementMonthlyCyclePreview `json:"monthly_cycle_preview"`
	ID                     int64                                  `json:"id"`
	PlanID                 *int64                                 `json:"plan_id"`
