...
func TestVerifyOrderPublicReturnsLegacyOrderState(t *testing.T) {
	...
	paymentSvc := service.NewPaymentService(client, payment.NewRegistry(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestResolveOrderPublicByResumeTokenReturnsFrontendContractFields(t *testing.T) {
	...
	paymentSvc := service.NewPaymentService(client, payment.NewRegistry(), nil, nil, nil, nil, nil, configSvc, nil, nil, nil, nil, nil)
	h := NewPaymentHandler(paymentSvc, nil)
