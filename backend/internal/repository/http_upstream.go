...
func buildUpstreamTransportWithTLSFingerprint(settings poolSettings, proxyURL *url.URL, profile *tlsfingerprint.Profile) (*http.Transport, error) {
	...
	dialerOptions := tlsfingerprint.DialerOptions{
	...
	if proxyURL == nil {
		...
		dialer := tlsfingerprint.NewDialerWithOptions(profile, dialerOptions)
		...
		case "socks5", "socks5h":
			...
			socks5Dialer := tlsfingerprint.NewSOCKS5ProxyDialerWithOptions(profile, proxyURL, dialerOptions)
		...
		case "http":
			...
			httpDialer := tlsfingerprint.NewHTTPProxyDialerWithOptions(profile, proxyURL, dialerOptions)
