...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// The runner hashes strings.TrimSpace(content). Keep the raw-file hashes as
	// accepted legacy values for databases whose rows were inserted manually.
