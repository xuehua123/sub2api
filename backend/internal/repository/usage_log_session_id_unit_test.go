...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 66, "arg-type table includes local billing/TTFT fields, upstream request ID, reasoning/native-compaction fields, and session_id")
