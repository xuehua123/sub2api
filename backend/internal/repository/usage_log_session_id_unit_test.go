...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 65, "arg-type table must include local billing/TTFT fields, upstream reasoning/native-compaction fields, and session_id")
