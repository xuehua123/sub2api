		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"connectivity_geoip_status": "not_configured",
...
func TestIssueRoutesAreRegistered(t *testing.T) {
	...
	for _, want := range []string{
		...
		"POST /api/v1/admin/issues/:id/pin",
		"POST /api/v1/admin/issues/:id/unpin",
		"POST /api/v1/admin/issues/:id/solution",
		"POST /api/v1/admin/issues/:id/solution/clear",
		"POST /api/v1/admin/issues/:id/related-issue",
		"POST /api/v1/admin/issues/:id/related-issue/clear",
...
func (stubUserSubscriptionRepo) List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status, platform, sortBy, sortOrder string, extra ...service.SubscriptionAdminFilters) ([]service.UserSubscription, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
