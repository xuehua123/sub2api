...
type AdminService interface {
	...
	// ListAccountsByUpstreamConnection scopes the account list to the accounts
	// bound to one shared upstream connection.
	ListAccountsByUpstreamConnection(ctx context.Context, page, pageSize int, platform, accountType, status, search string, groupID, upstreamConnectionID int64, privacyMode string, sortBy, sortOrder string) ([]Account, int64, error)
	...
	ListAccountsForSchedulerScoreFilterByUpstreamConnection(ctx context.Context, platform, accountType, status, search string, groupID, upstreamConnectionID int64, privacyMode string) ([]Account, error)
	...
	UpdateAccountTags(ctx context.Context, id int64, tags []string) ([]string, error)
...
func (s *adminServiceImpl) UpdateAccountTags(ctx context.Context, id int64, tags []string) ([]string, error) {
	normalized := NormalizeAccountTags(tags)
	if err := s.UpdateAccountExtra(ctx, id, map[string]any{AccountExtraTagsKey: normalized}); err != nil {
		return nil, err
	}
