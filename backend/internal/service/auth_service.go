...
func (s *AuthService) LoginOrRegisterOAuthWithTokenPair(ctx context.Context, email, username, invitationCode, referralCode, affiliateCode, signupSource string) (*TokenPair, *User, error) {
	return s.loginOrRegisterOAuthWithTokenPair(ctx, email, username, invitationCode, referralCode, affiliateCode, "", signupSource)
}
...
// is created.
func (s *AuthService) LoginOrRegisterOAuthWithTokenPairAndPromoCode(ctx context.Context, email, username, invitationCode, referralCode, affiliateCode, promoCode, signupSource string) (*TokenPair, *User, error) {
	return s.loginOrRegisterOAuthWithTokenPair(ctx, email, username, invitationCode, referralCode, affiliateCode, promoCode, signupSource)
}

func (s *AuthService) loginOrRegisterOAuthWithTokenPair(ctx context.Context, email, username, invitationCode, referralCode, affiliateCode, promoCode, signupSource string) (*TokenPair, *User, error) {
...
// bindReferralCodeForNewUser attempts to bind a referral code for a newly registered user.
// Failures are logged but do not block registration.
func (s *AuthService) bindReferralCodeForNewUser(ctx context.Context, userID int64, referralCode string) {
	if referralCode == "" || s.referralService == nil {
		return
	}
	if err := s.referralService.BindReferralCodeForNewUser(ctx, userID, referralCode, "registration"); err != nil {
