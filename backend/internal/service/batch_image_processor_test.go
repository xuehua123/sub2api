...
func (r *fakeBatchImageRepository) CreateBatchImageJob(_ context.Context, params CreateBatchImageJobParams) (*BatchImageJob, error) {
	job := &BatchImageJob{
		...
		EntitlementBalanceFallback: params.EntitlementBalanceFallback,
		HeldDailyWindowStart:       params.HeldDailyWindowStart,
		HeldWeeklyWindowStart:      params.HeldWeeklyWindowStart,
		HeldMonthlyWindowStart:     params.HeldMonthlyWindowStart,
