...
func TestCalculateCostWithServiceTier_Gpt54MiniPriorityWithoutPriceStaysStandard(t *testing.T) {
	svc := newTestBillingService()
...
func TestCalculateCostWithServiceTier_UnknownFastCapabilityWithoutPriceStaysStandard(t *testing.T) {
	svc := newTestBillingService()
	tokens := UsageTokens{InputTokens: 120, OutputTokens: 30, CacheCreationTokens: 12, CacheReadTokens: 8}
...
func TestCalculateCostWithServiceTier_CustomModelWithoutPriorityPriceStaysStandard(t *testing.T) {
...
func TestGetModelPricingWithChannel_OverrideInputPriceOnly(t *testing.T) {
	...
	// The model has no catalog Fast tier, so only the standard price is overridden.
...
func TestGetModelPricingWithChannel_CacheReadPriceAffectsPriority(t *testing.T) {
	...
	// The model has no catalog Fast tier, so the priority rate remains absent.
