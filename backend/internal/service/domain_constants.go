...
const (
	...
	SettingKeyConnectivityTestEnabled             = "connectivity_test_enabled"
	SettingKeyConnectivityClientIPEnabled         = "connectivity_client_ip_enabled"
	SettingKeyConnectivityGradeThresholds         = "connectivity_grade_thresholds"
	SettingKeyConnectivityProbeSamples            = "connectivity_probe_samples"
	SettingKeyConnectivityProbeWarmup             = "connectivity_probe_warmup"
	SettingKeyConnectivityProbeMaxConcurrency     = "connectivity_probe_max_concurrency"
	SettingKeyConnectivityProbeTimeoutMS          = "connectivity_probe_timeout_ms"
	SettingKeyConnectivityProbeAllowedOrigins     = "connectivity_probe_allowed_origins"
	SettingKeyConnectivityProbeIPRPM              = "connectivity_probe_ip_rpm"
	SettingKeyConnectivityProbeBurst              = "connectivity_probe_burst"
	SettingKeyModelPriceUSDCNYRate                = "model_price_usd_cny_rate" // 模型价格页 USD/CNY 汇率
	SettingKeyModelPriceCNYPerQuotaUSD            = "model_price_cny_per_quota_usd"
	...
	SettingKeyModelPriceHiddenModelKeys           = "model_price_hidden_model_keys"
