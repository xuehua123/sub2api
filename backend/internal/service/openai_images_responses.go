...
func (s *OpenAIGatewayService) forwardOpenAIImagesOAuth(
	...
	if direct {
		responsesBody, targetURL, err = buildOpenAIImagesOAuthPayload(normalizedParsed, upstreamModel)
	} else {
		responsesBody, err = buildOpenAIImagesResponsesRequest(normalizedParsed, upstreamModel)
	...
	upstreamReq = upstreamReq.WithContext(ContextWithAccountUpstreamGzipPolicy(upstreamReq.Context(), account))
