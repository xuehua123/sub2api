...
func normalizeValidityUnit(unit string) string {
...
func isSupportedValidityUnit(unit string) bool {
	switch normalizeValidityUnit(unit) {
	case validityUnitDay, validityUnitWeek, validityUnitMonth, validityUnitYear:
		return true
	default:
		return false
	}
