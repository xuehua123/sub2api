...
func TestHasIdentifiedResponseModelPricingRejectsNonTokenChannelPricing(t *testing.T) {
		...
		listAllFn: func(_ context.Context) ([]Channel, error) {
			return []Channel{{
				...
				ModelPricing: []ChannelModelPricing{{
					Platform:        "anthropic",
					Models:          []string{anthropicCheapFixtureModel},
	...
	identified, channelPriced := svc.hasIdentifiedResponseModelPricing(context.Background(), anthropicCheapFixtureModel, apiKey)
	require.False(t, identified)
	require.False(t, channelPriced)
}

func TestHasIdentifiedOpenAIResponsePricingRejectsNonTokenChannelPricing(t *testing.T) {
	...
	for _, mode := range []BillingMode{BillingModePerRequest, BillingModeImage} {
		t.Run(string(mode), func(t *testing.T) {
			...
			identified, channelPriced := svc.hasIdentifiedOpenAIResponsePricing(context.Background(), openAIPriceyFixtureModel, apiKey)
			require.False(t, identified)
			require.False(t, channelPriced)
		})
	}
