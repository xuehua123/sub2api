...
BEGIN
    ...
    IF OLD.key IS DISTINCT FROM NEW.key
       ...
       OR OLD.subscription_entitlement_id IS DISTINCT FROM NEW.subscription_entitlement_id
       OR OLD.access_source IS DISTINCT FROM NEW.access_source
       OR OLD.auto_switch_group_enabled IS DISTINCT FROM NEW.auto_switch_group_enabled
