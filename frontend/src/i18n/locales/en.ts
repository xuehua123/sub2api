export default {
  ...
  keys: {
    ...
    accessSourceColumn: 'Access source',
    accessSourceBalance: 'Balance access',
    accessSourceBalanceShort: 'Balance',
    accessSourceBalanceHint: 'Charge this key to wallet balance without binding a plan entitlement.',
    accessSourceEntitlement: 'Plan entitlement',
    accessSourceEntitlementHint: 'Charge this key to the shared quota of a selected plan entitlement.',
    accessSourceNoEntitlementHint: 'No available plan entitlement',
    accessSourceSwitchRequired: 'Choose an access source before switching to this group.',
    balanceDeductionHint: 'Uses wallet balance',
    switchAccessSourceShort: 'Change source',
