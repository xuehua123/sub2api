export default {
  ...
  nav: {
    ...
    adminReferral: 'Referral & Withdrawals',
    adminReferralWithdrawals: 'Withdrawal Review',
    docs: 'Docs',
    sora: 'Sora Studio'
  },
  ...
  referral: {
    ...
    description: 'Review referral codes, commission ledgers, and withdrawal records.',
    defaultCode: 'Default Referral Code',
    copyInviteLink: 'Copy Invite Link',
    copySuccess: 'Invite link copied',
    bindStatus: 'Binding Status',
    alreadyBound: 'Bound',
    notBound: 'Not Bound',
    boundCode: 'Bound Referral Code',
    bindPlaceholder: 'Enter a referral code to bind',
    bindAction: 'Bind Referral Relation',
    bindSuccess: 'Referral code bound successfully',
    bindValidating: 'Validating referral code...',
    bindCodeValid: 'Referral code is valid and ready to bind.',
    bindCodeInvalid: 'Referral code is invalid',
    bindPreview: 'Will bind to upstream account: {username} ({email})',
    payoutAccounts: 'Payout Accounts',
    payoutAccountsHint: 'Save a default payout account before creating withdrawals.',
    payoutAccountsWeeklyHint: 'Payout account updates are limited to once every 7 days.',
    editingAccount: 'Editing payout account',
    accountName: 'Account Name',
    alipayAccount: 'Alipay account',
    wechatAccount: 'WeChat ID / mobile',
    wechatQrUrl: 'WeChat payout QR URL (optional)',
    accountNo: 'Account Identifier',
    bankName: 'Bank Name (bank payouts only)',
    bankCardNo: 'Bank card number',
    makeDefaultAccount: 'Set as default payout account',
    saveAccount: 'Save payout account',
    updateAccount: 'Update payout account',
    accountSaved: 'Payout account saved',
    accountUpdated: 'Payout account updated',
    accountEditableNow: 'Editable now',
    accountNextEditableAt: 'Next editable time: {time}',
    withdrawal: 'Withdrawal Request',
    withdrawalHint: 'Available commission will be allocated and frozen by reward automatically.',
    withdrawMaxHint: 'Maximum withdrawable now: {amount}',
    withdrawTooLarge: 'Withdrawal amount cannot exceed available commission',
    withdrawAmount: 'Withdrawal amount',
    withdrawRemark: 'Remark (optional)',
    selectPayoutAccount: 'Select payout account',
    submitWithdrawal: 'Submit withdrawal request',
    withdrawalCreated: 'Withdrawal request created',
    invitees: 'Invitees',
    secondLevel: 'Second-level invitees',
    ...
    dashboardBannerTitle: 'Referral commission is enabled',
    dashboardBannerDesc: 'View your referral code, ledger, and withdrawal records.',
    convertToCredit: 'Convert commission to credit',
    convertDesc: 'Instantly credited to your platform balance for usage.',
    convertAmount: 'Amount to convert',
    convertSuccess: 'Successfully converted to platform credit',
    withdrawAll: 'Withdraw all',
    withdrawInvalid: 'Invalid withdrawal amount',
    availableToWithdraw: 'Maximum withdrawable amount',
    peopleCount: 'people',
    myInviteCodeTitle: 'My Referral Entry',
    myInviteCodeDesc: 'Share your exclusive link or referral code with friends.',
    inviteLink: 'Invite Registration Link',
    noPayoutAccountHint: 'Please add a payout account first',
    addNewAccount: 'Add New Account',
    payoutMethod: 'Payout Method',
    qrCode: 'Payment QR Code',
    accountCoolingDown: 'Account update cooling down',
    ...
    rewardPendingCredit: 'Reward Credit',
    rewardSettled: 'Reward Settled',
    withdrawFreeze: 'Withdraw Frozen',
    withdrawReturn: 'Withdraw Returned',
    withdrawPaid: 'Withdraw Paid',
    adminAdd: 'Admin Add',
    adminSubtract: 'Admin Subtract'
  },
  ...
  auth: {
    ...
    referralCodeValid: 'Referral code is valid and will bind after registration',
    referralCodeInvalid: 'Invalid referral code',
    referralCodeValidating: 'Validating referral code...',
    referralCodeInvalidCannotRegister: 'Invalid referral code. Please check and try again',
    linuxdo: {
    ...
    lobehub: {
      title: 'Continue to LobeHub',
      ssoDescription: 'We are finishing your sub2api SSO session and preparing the chat workspace.',
      continuing: 'Finishing secure sign-in and import flow...',
      retry: 'Try Again',
      retryHint: 'If the redirect did not happen automatically, you can continue manually.',
      invalidRequest: 'This LobeHub continuation link is invalid or has expired.',
      continueFailed: 'Failed to continue to LobeHub. Please try again.',
      selectKeyTitle: 'Choose Your Chat Key',
      selectKeyDescription: 'Pick the API key that direct-open should use for future LobeHub sessions.',
      continueWithKey: 'Continue With This Key',
      keyRequired: 'Please choose an API key first.',
      keysLoadFailed: 'Failed to load your available API keys.',
      noKeys: 'You do not have any active API keys yet. Create one first, then we will resume this chat flow.',
  ...
  admin: {
    ...
    referral: {
      ...
      description: 'Manage referral relations, commission rewards, and ledger entries.',
      withdrawals: 'Withdrawal Review',
      menuCommission: 'Commission',
      menuWithdrawals: 'Withdrawals',
      relations: 'Referral Relations',
      referrer: 'Referrer',
      bindCode: 'Referral Code',
      relationSearch: 'Search account email and pick the relation to rebind',
      targetAccount: 'Target Account',
      targetAccountSearch: 'Search target account email',
      upstreamAccount: 'Upstream Account',
      upstreamAccountSearch: 'Search upstream account email',
      fixedCodeHint: 'Referral codes are fixed. Select the account to rebind on the left, then enter the upstream account’s fixed referral code.',
      updateRelation: 'Rebind Relation',
      selectUserHint: 'Select a user from the left table first',
      relationCode: 'New referral code',
      reason: 'Reason for rebinding',
      saveRelation: 'Save referral relation',
      relationSaved: 'Referral relation updated',
      viewRelationHistory: 'View relation history',
      relationHistoryTitle: 'Relation History',
      historyOldReferrer: 'Previous referrer ID',
      historyNewReferrer: 'New referrer ID',
      historyOldCode: 'Previous referral code',
      historyNewCode: 'New referral code',
      rewards: 'Commission Rewards',
      owner: 'Commission Owner',
      sourceUser: 'Paying User',
      rewardSearch: 'Search commission owner account and pick the reward to adjust',
      adjustment: 'Manual Adjustment',
      adjustSelectionHint: 'Filter on the left and select a reward row for the target account before submitting the adjustment.',
      adjustAccount: 'Adjustment Account',
      selectRewardHint: 'Select a reward from the left table first',
      adjustAmount: 'Positive to add, negative to deduct',
      adjustRemark: 'Adjustment remark',
      submitAdjustment: 'Submit adjustment',
      adjustmentSaved: 'Adjustment submitted',
      ledger: 'Commission Ledger',
      withdrawalReviewTitle: 'Withdrawal Review',
      withdrawalReviewDescription: 'Inspect item allocations and execute approve, reject, or mark-paid actions.',
      approve: 'Approve',
      reject: 'Reject',
      markPaid: 'Mark Paid',
      ...
      rejectReasonDefault: 'Rejected manually',
      withdrawalItemsTitle: 'Withdrawal Items',
      allocatedAmount: 'Allocated Amount',
      netAllocatedAmount: 'Net Amount',
      feeAllocatedAmount: 'Fee Allocation',
      rechargeOrderId: 'Recharge Order ID',
      infoArchitecture: 'Overview finds / Tree explains / Workspace acts',
      overviewTitle: 'Overview',
      overviewDesc: 'Start with the overall scale, pending withdrawals, and the last 7 days of commission rhythm.',
      totalAccountsHint: 'Accounts with referral relations or commission activity',
      totalBoundUsersHint: 'Users currently bound into a referral hierarchy',
      pendingCommissionHint: 'Not yet moved into the withdrawable bucket',
      availableCommissionHint: 'Currently withdrawable by users',
      frozenCommissionHint: 'Already in the withdrawal flow and waiting for review or payout',
      withdrawnCommissionHint: 'Already paid out and settled',
      trendTitle: 'Last 7 Days Trend',
      trendDesc: 'See newly created commissions and withdrawal requests together to understand the current pace.',
      lastSevenDays: 'Last 7 days',
      rewardShort: 'R',
      withdrawShort: 'W',
      rewardTrendLegend: 'New commissions',
      withdrawTrendLegend: 'Withdrawal requests',
      hierarchySummary: 'Hierarchy',
      commissionSummary: 'Commission',
      fixedReferralCode: 'Fixed Referral Code',
      pendingWithdrawalCount: 'Pending Count',
      pendingWithdrawalAmountLabel: 'Pending Net Amount',
      treeDesc: 'Only show two levels here so the admin page stays readable.',
      treeRoot: 'Root Account',
      levelOneAccount: 'Level 1 Account',
      levelTwoAccounts: 'Level 2 Accounts',
      workspaceTitle: 'Account Workspace',
      workspaceTabRelation: 'Relation Flow',
      workspaceTabAdjustment: 'Manual Adjustment',
      workspaceTabHistory: 'Relation History',
      workspaceTabWithdrawals: 'Withdrawal Details',
      relationWorkbenchTitle: 'Relation Workflow',
      relationWorkbenchDesc: 'Admins choose the upstream account only. The fixed referral code is filled automatically instead of typed manually.',
      relationConfirmTitle: 'Confirmation',
      selectedUpstream: 'Will bind to',
      fixedCodeReadonlyHint: 'Default referral codes are fixed values. They are shown here, not editable.',
      adjustmentDesc: 'This workspace is already scoped to the current account. Pick the exact reward first, then apply a positive or negative adjustment.',
      rewardLevel: 'Level',
      rewardSelected: 'Selected',
      selectedRewardSummary: 'Selected reward',
      relationHistoryDesc: 'Every manual rebind and source change is kept here for troubleshooting.',
      bindCodeChange: 'Referral code change',
      withdrawalItemsDesc: 'Stay in the workspace and inspect each withdrawal for the current account without leaving the page.',
      selectedWithdrawal: 'Selected Withdrawal',
      selectWithdrawalHint: 'Choose a withdrawal from the left side first.',
      // Hardcoded Chinese replacements
      fromActiveRelations: 'From {count} active referral relations',
      pendingQueueCount: '{count} pending in review queue',
      historicalPaidOut: 'Historical total paid out',
      viewAll: 'View all',
      ...
      availableCommission: 'Total Available (CNY)',
      pendingCommission: 'Total Pending',
      frozenCommissionTitle: 'Frozen Funds',
      withdrawnCommission: 'Total Withdrawn',
      pendingWithdrawalsTitle: 'Quick Review',
      quickOpenAccountPlaceholder: 'Search account email to open workspace...',
      inviteCode: 'Invite Code',
      directSlashViral: 'Direct / Viral',
      peopleSuffix: 'people',
      totalCommission: 'Total Commission',
      codeLabel: 'Code',
      totalContribution: 'Contribution',
      manageThisPerson: 'Manage',
      theirInvitesViral: 'Their invites (viral)',
      noInviteesYet: 'This account has not invited anyone yet.',
      promoCode: 'Referral Code',
      directDownline: 'Direct downline',
      viralNetwork: 'Viral network',
      totalCommissionOutput: 'Total commission output',
      tabChangeReferrer: 'Change Referrer',
      tabCommissionAdjust: 'Commission Adjust',
      tabWithdrawalRecords: 'Withdrawal Records',
      tabChangeLog: 'Change Log',
      changeReferrerTitle: 'Change Referrer (Upstream)',
      changeReferrerDesc: 'Modify the upstream referrer. New orders will reward the new upstream.',
      currentUpstream: 'Current upstream',
      organicSignup: 'Organic signup (no upstream)',
      viewHierarchy: 'View hierarchy',
      searchNewUpstream: 'Search new upstream account',
      searchByEmailPlaceholder: 'Search by email...',
      willBindTo: 'Will bind to',
      changeReasonLabel: 'Reason for change (required for audit)',
      changeReasonPlaceholder: 'e.g., Customer requested upstream change, ticket #1024',
      confirmChangeUpstream: 'Confirm change upstream',
      rewardTrackingTitle: 'Reward Order Tracking',
      rewardTrackingDesc: 'Browse each commission entry from downline, or manually adjust specific orders.',
      noRewardRecords: 'No traceable commission records',
      manualAdjustTitle: 'Manual adjustment for this reward',
      ...
      adjustRemarkLabel: 'Adjustment note',
      adjustReasonPlaceholder: 'Adjustment reason...',
      executeAdjustment: 'Execute adjustment',
      selectOrderFirst: 'Please select an order from the left first',
      ...
      viewDetails: 'Review Details / Approve',
      noWithdrawalText: 'All withdrawal requests have been processed, or no withdrawals have been initiated yet.',
      withdrawalUserEmail: 'Account Owner',
      dossierNo: 'Dossier No.',
      poolComposition: 'Pool Composition',
      paymentSource: 'Payment source',
      auditNoActions: 'Dossier sealed (LOCKED)'
    },
    ...
    settings: {
      ...
      invitationAccess: {
        title: 'Access Invitation Codes',
        description: 'Control whether registration requires a platform-issued invitation code.'
      },
      registrationPromo: {
        title: 'Registration Promo Codes',
        description: 'Control whether signup can use bonus-balance promo codes.'
      },
      referral: {
        title: 'Referral Commission',
        description: 'Configure referral binding, commission rewards, settlement delay, and withdrawals.',
        enabled: 'Enable referral commission',
        enabledHint: 'Turn on the dedicated referral code, relation, and commission workflow.',
        level1Enabled: 'Enable level 1 commission',
        level1EnabledHint: 'Reward the direct referrer when an invited user pays.',
        ...
        bindBeforeFirstPaidOnly: 'Allow binding only before first paid order',
        bindBeforeFirstPaidOnlyHint: 'When enabled, end users can no longer rebind after the first paid recharge.',
        allowManualInput: 'Allow manual referral code input',
        allowManualInputHint: 'Users can type a referral code during registration or other allowed flows.',
        withdrawEnabled: 'Enable commission withdrawals',
        withdrawEnabledHint: 'Allow users to submit available commission for manual review and payout.',
        withdrawMinAmount: 'Minimum withdrawal amount',
        withdrawMaxAmount: 'Maximum single withdrawal amount',
        ...
        refundReverseEnabled: 'Reverse commission on refunds',
        refundReverseEnabledHint: 'Automatically reverse commission for refunds, chargebacks, and rollbacks.',
        negativeCarryEnabled: 'Allow negative carry after paid withdrawals',
        negativeCarryEnabledHint: 'When a paid reward is reversed, carry it forward as a negative commission balance.',
      ...
      lobehub: {
        ...
        description: 'Configure official LobeHub OIDC login and settings import behavior.',
        enabled: 'Enable LobeHub integration',
        enabledHint: 'Turn on user launch entry points and the sub2api LobeHub OIDC provider.',
        chatUrl: 'Chat URL',
        chatUrlPlaceholder: 'https://chat.example.com',
        chatUrlHint: 'Public LobeHub domain used for bridge redirects and direct-open flows.',
        oidcIssuer: 'OIDC Issuer',
        oidcIssuerPlaceholder: 'https://api.example.com',
        oidcIssuerHint: 'Issuer used by LobeHub Generic OIDC. Keep it separate from the model base URL.',
        clientId: 'OIDC Client ID',
        clientIdPlaceholder: 'sub2api-lobehub',
        clientIdHint: 'Must match the Generic OIDC client id configured in LobeHub env vars.',
        ...
        clientSecretHint: 'Used when LobeHub exchanges authorization codes at the token endpoint.',
        clientSecretConfiguredHint: 'A secret already exists. Leave blank to keep it, or enter a new one to rotate.',
        defaultProvider: 'Default Provider',
        defaultProviderPlaceholder: 'openai',
        defaultProviderHint: 'Provider name written into imported settings. Keep openai for the first release.',
        defaultModel: 'Default Model',
        defaultModelPlaceholder: 'gpt-4.1',
        defaultModelHint: 'Optional default model passed into imported LobeHub settings.',
        runtimeConfigVersion: 'Runtime Config Version',
        runtimeConfigVersionPlaceholder: '2026-04-07',
        runtimeConfigVersionHint:
          'Bump this whenever any global import behavior changes so chat-side target refreshes automatically.',
        hideImportButton: 'Hide import button',
        hideImportButtonHint: 'Hide the user-side "Import and Open LobeHub" button on the Keys page.'
      },
      purchase: {
