export default {
  ...
  issueCenter: {
    ...
    scenario: {
      ...
      slow_timeout: 'Slow / timeout',
      payment: 'Payment / balance',
      model_unavailable: 'Model unavailable',
      login_key: 'Login / API key',
      other: 'Other'
    },
    roles: {
      admin: 'Admin',
    ...
    detail: {
      ...
      pinned: 'Pinned',
      solution: 'Solution',
      relatedSolvedIssue: 'Linked solved issue',
      relatedIssueLink: 'Related issue {publicId}'
    },
    new: {
      title: 'Submit Issue',
      description: 'Fill in the account email, time, screenshot, and screenshot text so admins can diagnose the issue once.',
      titlePlaceholder: 'Short summary, for example: Balance deducted but Claude returns 429',
      titleHint: 'Use one short sentence. Do not put screenshots or long logs in the title.',
      basicInfoTitle: 'Basic info',
      basicInfoHint: 'Choose the scenario and occurrence time first, then add evidence below.',
      scenarioLabel: 'Issue type / scenario',
      problemDetailsTitle: 'Error and description',
      problemDetailsHint: 'Separate what happened from what you were doing so admins can reproduce it.',
      errorSummaryLabel: 'Error / symptom',
      errorSummaryPlaceholder: 'Example: Claude Code waits 40 seconds then times out, or returns insufficient_quota.',
      descriptionLabel: 'Description / reproduction',
      descriptionPlaceholder: 'Describe what you did, what you expected, and what actually happened. Do not only write "slow" or "see screenshot".',
      screenshotEvidenceTitle: 'Screenshot and text',
      screenshotEvidenceHint: 'Upload screenshots, but also copy the Chinese or English text from the screenshot for search and diagnosis.',
      screenshotTextLabel: 'Original Chinese / English text in screenshot',
      screenshotTextPlaceholder: 'Paste the exact text shown in the screenshot, for example: Your account is temporarily unavailable.',
      screenshotMeaningLabel: 'Meaning / your interpretation (optional)',
      screenshotMeaningPlaceholder: 'If the screenshot is in English, write the Chinese meaning. If it is a platform prompt, describe the impact you understand.',
      pasteImageHint: 'You can paste an image here; it will be uploaded to the screenshot area.',
      reportLabel: 'Issue and description',
      reportPlaceholder: 'Use the first line as the issue title. Then describe what happened, what you expected, the actual error, and the text shown in screenshots. Paste or drag screenshots here.',
      reportHint: 'The first line becomes the title. The full content is submitted as the issue description and screenshot text. Do not paste HTML or a full API key.',
      requiredInfoTitle: 'Required info',
      diagnosticsTitle: 'Diagnostic info',
      diagnosticsHint: 'Select request logs from a time range; model and client fields are attached automatically.',
      manualDiagnosticsTitle: 'Manually adjust diagnostic fields (optional)',
      emailAutoHint: 'Uses the current signed-in account email and masks it in public views.',
      occurredAtHint: 'Defaults to the current browser time, precise to the minute.',
      loadLogs: 'Load recent logs',
      logsFailed: 'Failed to load recent logs.',
      noLogs: 'No selectable request logs in the last 24 hours.',
      logRangeStart: 'Log range start',
      logRangeEnd: 'Log range end',
      logRangeError: 'Choose a valid log time range.',
      selectLogLabel: 'Select request log',
      selectLogPlaceholder: 'Choose a recent request log',
      selectedLogsCount: '{count} logs selected',
      selectAllLogs: 'Select all',
      clearSelectedLogs: 'Clear',
      selectedLogPayloadTitle: 'Selected request log diagnostics',
      logNumber: 'Log #{number}',
      logId: 'Log ID',
      logTime: 'Log time',
      logApiKey: 'API key name',
      ...
      dropTitle: 'Drag screenshots here',
      dropActive: 'Release to upload',
      dropHint: 'Paste, drag, or choose PNG, JPEG, WebP, and GIF images. Max 5MB each, up to 5 files.',
      uploadedScreenshots: 'Uploaded screenshots',
      uploading: 'Uploading...',
      similarTitle: 'Possible related issues',
      similarHint: 'Automatically checks the current description, log status, and error code without blocking submission.',
      similarChecking: 'Checking',
      similarFound: '{count} possible related issues found',
      similarContinue: 'Open one first, or continue submitting this issue.',
      findSimilar: 'Find similar',
      completenessTitle: 'Diagnostic completeness',
      completenessReady: 'Ready',
      completenessNeedsInfo: 'Needs info',
      completenessWithLogs: '{count} request logs selected. Diagnostic info is sufficient.',
      completenessBasicReady: 'Basic description and screenshot text are filled. For slow requests, selecting logs is recommended.',
      completenessSlowNeedsLogs: 'Slow / timeout issues need request logs, or a time range, model/client, and a clear description.',
      submit: 'Submit issue',
      requiredError: 'Please complete all required fields.',
      lowQualityError: 'The description is too short or too generic. Add what you did, what you expected, what happened, or select relevant request logs.',
      slowEvidenceError: 'Slow / timeout issues need at least one request log, or a time range, model/client, and a clear description.',
    ...
    admin: {
      ...
      emptyDescription: 'Adjust the search filters or clear them and try again.',
      backToList: 'Back to Issue Management',
      ...
      resolvedByUserID: 'Resolved by user ID',
      authorUserID: 'Author user ID',
      actorUserID: 'Actor user ID',
      hiddenByUserID: 'Hidden by user ID',
      ...
      confirmHideAttachment: 'Hide this attachment?',
      events: 'Events',
      ...
      pinnedAt: 'Pinned at',
      pinnedByUserID: 'Pinned by user ID',
      pinnedReason: 'Pinned reason',
      pinIssue: 'Pin issue',
      unpinIssue: 'Unpin issue',
      currentlyPinned: 'This issue is currently pinned and prioritized in lists.',
      pinHint: 'Use for announcements, common solutions, and frequent duplicate issues.',
      solutionComment: 'Solution comment',
      solutionCommentID: 'Solution comment ID',
      selectComment: 'Select a public comment',
      markSolution: 'Mark solution',
      clearSolution: 'Clear solution',
      relatedIssue: 'Related issue',
      relatedIssueID: 'Related solved issue ID',
      relatedIssueReason: 'Related issue reason',
      currentRelatedIssue: 'Current link',
  ...
  keys: {
    ...
    currentGroupLabel: 'Current group / rate',
    changeGroup: 'Change group',
    accessSourceLabel: 'Quota source',
    accessSourceColumn: 'Quota source',
    accessSourceBalance: 'Balance',
    accessSourceBalanceShort: 'Balance',
    accessSourceBalanceHint: 'Charge this key to wallet balance by usage.',
    accessSourceEntitlement: 'Subscription plan',
    accessSourceEntitlementHint: 'Charge this key to the shared quota of a purchased subscription plan.',
    accessSourceNoEntitlementHint: 'No available subscription plan',
    accessSourceSwitchRequired: 'Choose a quota source before switching to this group.',
    balanceDeductionHint: 'Uses wallet balance',
    switchAccessSourceShort: 'Change quota',
    switchEntitlement: 'Change plan card',
    planCardBadge: 'Plan card',
    ...
    clickToChangeEntitlement: 'Change which plan card this key consumes',
    noEntitlement: 'No plan card selected',
    entitlementLabel: 'Subscription plan card',
    entitlementSelectPlaceholder: 'Select a plan card',
    entitlementAutoSelected: 'Selected plan card',
    entitlementRequired: 'Please choose which plan card this key should consume',
    entitlementSelectionRequired: 'This group is included in multiple plan cards. Choose which card to consume first.',
    entitlementChooseFirstHint: 'Choose the plan card this key will consume, then choose a group included in that card.',
    entitlementSelectedHint: 'This key will consume the selected plan card shared quota.',
    currentGroupFilteredHint: 'Only groups included in the selected plan card are shown. Each group consumes that card quota at its own rate.',
    currentGroupRateHint: 'Consumes plan card quota at {rate}',
    entitlementSingleHint: 'This group will use the selected plan card shared quota.',
    entitlementMultipleHint: 'Multiple plan cards include this group. Choose which card this key should consume.',
    entitlementSingleAvailable: 'Included in 1 plan card',
    entitlementMultipleAvailable: 'Included in {count} plan cards',
    entitlementCurrentCardIncludesGroup: 'Included in the current plan card',
    entitlementFallbackName: 'Plan card {id}',
    entitlementPlan: 'Plan #{id}',
    entitlementIncludedGroups: 'Includes {count} groups',
    entitlementExpires: 'Expires {date}',
  ...
  admin: {
    ...
    users: {
      ...
      columns: {
        ...
        concurrency: 'Concurrency',
        status: 'Status',
        referralStatus: 'Referral Access',
      ...
      referralGlobalEnabled: 'Global enabled',
      referralUserEnabled: 'Enabled for user',
      referralDisabled: 'Disabled',
      enableReferral: 'Enable referral',
      disableReferral: 'Disable referral',
      referralEnabledSuccess: 'Referral enabled for this user',
      referralDisabledSuccess: 'Referral disabled for this user',
      failedToToggleReferral: 'Failed to update referral access',
    ...
    groups: {
      ...
      sortOrder: 'Sort',
      showHistoricalGroups: 'Show historical groups',
      columnSettings: 'Column Settings',
      ...
      capabilities: {
        title: 'Quota Source Switches',
        hint: 'Control whether API keys may use this group through balance or subscription plans. Plan quotas are configured in subscription plan management.',
        ...
        subscriptionEnabledHint: 'Subscription plan cards may grant this group; users can use it after purchase.',
        planAutoGrantEnabled: 'Auto-include in plan scopes',
        planAutoGrantEnabledShort: 'Auto Include',
        planAutoGrantEnabledHint: 'Plans using "all subscription groups" or platform-based access will include this group automatically.',
    ...
    // Subscriptions
    subscriptions: {
      title: 'Plan Assignment Management',
      description: 'Manage user plans and quota limits',
      assignSubscription: 'Assign Plan',
      adjustSubscription: 'Adjust Plan',
      revokeSubscription: 'Revoke Plan',
      ...
      planHint: 'Selecting a plan automatically uses its entitlement group and validity',
      validityHint: 'Defaults to the selected plan validity, adjustable for testing',
      planValidityDays: '{days} days',
      planId: 'Plan ID #{id}',
      ...
      adjustHint: 'Enter positive number to extend the plan, negative to shorten it (remaining days must be > 0)',
      assign: 'Assign',
      assigning: 'Assigning...',
      adjust: 'Adjust',
      adjusting: 'Adjusting...',
      ...
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      cycleAdjustment: 'Cycle Adjust',
      cycleAdjustmentTitle: 'Adjust Usage Cycle',
      cycleAdjustmentFor: 'Adjusting cycle for',
      cycleAdjustmentMode: 'Adjustment mode',
      cycleAdjustmentModes: {
        advanceNextCycle: 'Use next monthly quota now',
        compensateReset: 'Support compensation reset',
        alignToReset: 'Align by reset time',
        alignToExpiry: 'Align by expiration',
        custom: 'Custom cycle'
      },
      cycleAdjustmentModeHints: {
        advance_next_cycle: 'Same as the user-side action: reset monthly usage, start the monthly window now, and deduct the remaining time before the old reset.',
        compensate_reset: 'Reset monthly quota and reset time without deducting validity; use only for payment or callback recovery.',
        align_to_reset: 'Keep the current monthly window anchor and recalculate expiration by cycle count.',
        align_to_expiry: 'Keep the current expiration and back-calculate the monthly window start by cycle count.',
        custom: 'Manually set monthly window start and expiration.'
      },
      cycleCount: 'Cycle count',
      cycleCountHint: 'One cycle is 30 days. For multi-month plans, use the actual remaining full-cycle count.',
      customMonthlyWindowStart: 'Monthly window start',
      customExpiresAt: 'Expiration',
      resetMonthlyUsage: 'Clear monthly usage',
      resetMonthlyUsageForcedHint: 'This mode refreshes quota, so monthly usage must be reset.',
      resetMonthlyUsageOptionalHint: 'Turn on only when this adjustment should also refresh monthly quota.',
      cycleAdjustmentReason: 'Reason',
      cycleAdjustmentReasonPlaceholder: 'For example: payment callback recovery or support-confirmed cycle alignment',
      previewAdjustment: 'Preview',
      previewing: 'Previewing...',
      applyCycleAdjustment: 'Apply Adjustment',
      applyingCycleAdjustment: 'Applying...',
      cycleAdjustmentApplied: 'Cycle adjusted successfully',
      failedToPreviewCycleAdjustment: 'Failed to preview cycle adjustment',
      failedToApplyCycleAdjustment: 'Failed to apply cycle adjustment',
      ...
      deductedValidity: 'Deducted validity',
      ...
      cycleCountRequired: 'Enter a valid cycle count',
      cycleCountOutOfRange: 'Cycle count cannot exceed {max}',
      customTimesRequired: 'Select custom monthly window start and expiration',
      cycleAdjustmentReasonRequired: 'Compensation reset requires a reason',
      cycleAdjustmentReasonTooLong: 'Reason cannot exceed {max} characters',
      cycleAdjustmentUnavailable: {
        generic: 'This plan cannot be adjusted right now',
        inactive_subscription: 'This plan is not in an adjustable state',
        expired_subscription: 'This plan is expired or has not started',
        monthly_limit_required: 'This plan has no monthly quota limit, so next monthly quota cannot be advanced',
        monthly_usage_not_exhausted: 'Monthly usage has not reached 90%, so next monthly quota cannot be advanced',
        invalid_reset_window: 'The current monthly reset window is invalid',
        no_future_monthly_cycle: 'Validity does not cover a full next 30-day cycle',
        reason_required: 'A reason is required',
        custom_times_required: 'Custom times are required',
        monthly_window_start_in_future: 'Monthly window start cannot be in the future',
        expires_at_not_in_future: 'Expiration must be later than now',
        expires_at_must_be_after_window_start: 'Expiration must be later than the monthly window start',
        cycle_count_out_of_range: 'Cycle count is outside the supported range',
        expires_at_after_max: 'Expiration cannot be later than the system maximum',
        reason_too_long: 'Reason is too long'
      },
      cycleAdjustmentWarnings: {
        compensate_reset_does_not_deduct_validity: 'Compensation reset does not deduct validity. Confirm this is a support compensation case.',
        monthly_usage_will_reset: 'Monthly usage will be reset to zero.',
        expires_at_will_extend: 'Expiration will be extended.',
        expires_at_will_shorten: 'Expiration will be shortened.'
      },
      noSubscriptionsYet: 'No assigned plans yet',
      assignFirstSubscription: 'Assign a plan to get started.',
      subscriptionAssigned: 'Plan assigned successfully',
      subscriptionAdjusted: 'Plan adjusted successfully',
      subscriptionRevoked: 'Plan revoked successfully',
      failedToLoad: 'Failed to load plan assignments',
      failedToAssign: 'Failed to assign plan',
      failedToAdjust: 'Failed to adjust plan',
      failedToRevoke: 'Failed to revoke plan',
      ...
      selectedPlanUnavailable: 'The selected plan has no assignable subscription group',
      validityDaysRequired: 'Please enter a valid number of days (at least 1)',
      revokeConfirm:
        "Are you sure you want to revoke the plan for '{user}'? You can restore it later from the revoked list.",
      restoreConfirm:
        "Restore the plan for '{user}'? If the original plan has expired, it will be restored as expired.",
      guide: {
    ...
    accounts: {
      ...
      openaiHttpProtocol: 'OpenAI upstream HTTP protocol',
      openaiHttpProtocolDesc: 'Choose whether this OpenAI account follows the global default, forces HTTP/1.1, or forces HTTP/2. HTTP/1.1 opens more TCP connections and can avoid HTTP/2 multiplexing tail latency.',
      openaiHttpProtocolDefault: 'Default (global)',
      openaiHttpProtocolH1: 'HTTP/1.1 (H1)',
      openaiHttpProtocolH2: 'HTTP/2 (H2)',
    ...
    usage: {
      ...
      entitlementIdPlaceholder: 'Exact entitlement ID',
      billingSource: {
        label: 'Billing Source',
        balance: 'Balance',
        legacy_subscription: 'Legacy Subscription',
        entitlement_quota: 'Entitlement Quota',
        entitlement_balance_fallback: 'Entitlement Overage Balance Fallback',
      },
      ipAddress: 'IP',
    ...
    settings: {
      ...
      referral: {
        ...
        description: 'Configure referral and commission system',
        enableReferral: 'Enable Referral System',
        enableReferralDesc: 'Allow users to earn commissions by inviting others',
        level1Enabled: 'Enable level 1 commission',
        level1Rate: 'Level 1 Commission Rate',
        rateHint: '0-1, e.g. 0.1 = 10%',
        rewardMode: 'Reward Mode',
        rewardModeFirstPaidOrder: 'First paid order only',
        rewardModeEveryPaidOrder: 'Every paid order',
        settlementDelayDays: 'Settlement delay (days)',
        settlementCurrency: 'Settlement Currency',
        allowManualInput: 'Allow Manual Referral Code Input',
        allowManualInputDesc: 'Allow users to manually enter a referral code after registration',
        bindBeforeFirstPaidOnly: 'Bind Before First Payment Only',
        bindBeforeFirstPaidOnlyDesc: 'Only allow binding a referrer before the user makes their first payment',
        withdrawEnabled: 'Enable Withdrawals',
        withdrawEnabledDesc: 'Allow users to withdraw their referral commission',
        creditConversionEnabled: 'Enable Balance Conversion',
        creditConversionEnabledDesc: 'Allow users to convert available referral commission into platform balance.',
        ...
        withdrawFixedFee: 'Fixed Withdrawal Fee',
        withdrawManualReviewRequired: 'Require Manual Review',
        refundReverseEnabled: 'Reverse Commission on Refund',
        negativeCarryEnabled: 'Allow Negative Carry',
      ...
      lobehub: {
        title: 'LobeHub Integration',
        description: 'Configure LobeHub chat integration and OIDC authentication',
        enableLobeHub: 'Enable LobeHub',
        enableLobeHubDesc: 'Enable LobeHub chat integration for users',
        chatUrl: 'LobeHub Chat URL',
        oidcIssuer: 'OIDC Issuer URL',
        oidcIssuerHint: 'Usually auto-generated as {api_base_url}/lobehub/oidc',
        oidcClientId: 'OIDC Client ID',
        oidcClientSecret: 'OIDC Client Secret',
        oidcClientSecretConfigured: '(secret already configured)',
        oidcClientSecretPlaceholder: 'Enter OIDC client secret',
        defaultProvider: 'Default Provider',
        defaultModel: 'Default Model',
        runtimeConfigVersion: 'Runtime Config Version',
        hideImportButton: 'Hide LobeHub Import Button',
        hideImportButtonDesc: 'Hide the LobeHub import button in the user interface',
      },
    ...
    referral: {
      ...
      menuCommission: 'Overview',
      menuWithdrawals: 'Withdrawal Review',
      availableCommission: 'Currently Withdrawable Total (CNY)',
      fromActiveRelations: 'From {count} active referral relation(s)',
      pendingCommission: 'Pending Commission Total',
      pendingCommissionHint: 'Commission not yet settled',
      frozenCommissionTitle: 'Frozen Funds',
      pendingQueueCount: '{count} pending withdrawal review(s)',
      withdrawnCommission: 'Withdrawn Commission',
      historicalPaidOut: 'Historically paid out',
      trendTitle: 'Income / Expense Trend in the Last 7 Days',
      pendingWithdrawalsTitle: 'Quick Review Queue',
      viewAll: 'View All',
      goToProcess: 'Process',
      noPendingRecords: 'No pending records',
      rankingTitle: 'Referral Agent Ranking',
      rankColumn: 'Rank',
      ...
      rewardTrendLegend: 'New Referral Commission',
      withdrawTrendLegend: 'Referral Withdrawal Outflow',
      treeTitle: 'Referral Structure Tree',
      treeRoot: 'Root',
      ...
      manageThisPerson: 'Manage This User',
      noInviteesYet: 'No invitees yet',
      workspaceTitle: 'Referral Workspace',
      promoCode: 'Referral Code',
      directDownline: 'Direct Downline',
      totalCommissionOutput: 'Total Commission Paid',
      changeReferrerTitle: 'Change Referrer',
      changeReferrerDesc: 'Assign a new upstream referrer for this user and record the reason.',
      currentUpstream: 'Current Upstream',
      organicSignup: 'Organic Signup',
      viewHierarchy: 'View Hierarchy',
      searchNewUpstream: 'Search New Upstream',
      searchByEmailPlaceholder: 'Search new upstream by email',
      willBindTo: 'Will bind to',
      changeReasonLabel: 'Change Reason',
      changeReasonPlaceholder: 'Enter the reason for this change',
      confirmChangeUpstream: 'Confirm Upstream Change',
      rewardTrackingTitle: 'Commission Tracking',
      rewardTrackingDesc: 'View related commission orders and payout records for this account.',
      noRewardRecords: 'No commission records',
      manualAdjustTitle: 'Manual Adjustment',
      currentSelectedOrder: 'Currently Selected Order',
      adjustAmountLabel: 'Adjustment Amount (¥)',
      positiveAddNegativeDeduct: 'Positive adds, negative deducts',
      adjustRemarkLabel: 'Adjustment Remark',
      ...
      withdrawalRequestRecords: 'Withdrawal Requests',
      noWithdrawalActions: 'No withdrawal records',
      accountTrailTitle: 'Account Change Trail',
      systemChange: 'System Change',
      reasonLabel: 'Reason',
      noDescription: 'No description',
      none: 'None',
      noChangeRecords: 'No change records',
      tabChangeReferrer: 'Change Referrer',
      tabCommissionAdjust: 'Commission Adjustment',
      tabWithdrawalRecords: 'Withdrawal Records',
      tabChangeLog: 'Change Log',
      relationSaved: 'Upstream referrer updated successfully',
      adjustmentSaved: 'Adjustment completed',
      withdrawalReviewTitle: 'Withdrawal Management',
      withdrawalReviewDescription: 'Review and process user commission withdrawal requests',
      withdrawalNo: 'Withdrawal No.',
      withdrawalUser: 'User',
      withdrawalAmount: 'Requested Amount',
      withdrawalFee: 'Fee',
      withdrawalNet: 'Net Amount',
      withdrawalPayoutMethod: 'Payout Method',
      viewDetails: 'Review',
      noWithdrawalText: 'There are no withdrawal requests to process right now',
      withdrawalItemsTitle: 'Withdrawal Review',
      userInfo: 'User Info',
      username: 'Username',
      withdrawalDetails: 'Withdrawal Details',
      payoutAccountNo: 'Payout Account',
      submitTime: 'Submitted At',
      reviewTime: 'Reviewed At',
      paymentTime: 'Paid At',
      rejectReason: 'Reject Reason',
      commissionSource: 'Commission Source Details',
      allocatedAmount: 'Allocated Amount',
      feeAllocatedAmount: 'Fee',
      netAllocatedAmount: 'Net Amount',
      rejectReasonPlaceholder: 'Enter reject reason (required)',
      confirmReject: 'Confirm Reject',
      reject: 'Reject Request',
      approve: 'Approve',
      markPaid: 'Mark as Paid',
      auditNoActions: 'Completed',
      approveSuccess: 'Withdrawal approved',
      rejectSuccess: 'Withdrawal rejected',
      markPaidSuccess: 'Payment marked as completed'
    }
  },
  ...
  subscriptionProgress: {
    ...
    activeCount: '{count} active plan(s)',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    ...
    noSubscriptions: 'No active plans',
    unlimited: 'Unlimited'
  },
  ...
  userSubscriptions: {
    ...
    noActiveSubscriptionsDesc:
      "You don't have any active plans. Contact administrator to get one.",
    failedToLoad: 'Failed to load plans',
    deleteTitle: 'Delete plan',
    deleteConfirm: 'Delete "{name}"? This subscription will stop being available immediately, and bound API keys may need a new quota source.',
    ...
    advanceMonthlyUnavailableAlias: 'This row is backed by a plan entitlement. Use the entitlement card to advance the monthly quota.',
    ...
    advanceEntitlementMonthlyUnavailableNoExpiration: 'Plan entitlements without an expiration cannot use the next monthly card early',
    advanceEntitlementMonthlyUnavailableNoMonthlyLimit: 'Monthly quota is not configured for this plan entitlement',
    advanceEntitlementMonthlyUnavailableWindow: 'This entitlement monthly cycle cannot be advanced right now',
    advanceEntitlementMonthlyUnavailableValidity: 'This entitlement does not cover a full next 30-day cycle',
    advanceEntitlementMonthlyConfirm: 'Use the next monthly card quota for "{entitlement}" now? Current usage is ${used} / ${limit}; the remaining ${remaining} quota will be forfeited. Monthly usage will reset, the new entitlement cycle will start now, and about {duration} will be deducted from this entitlement validity.',
    advanceEntitlementMonthlySuccess: 'Entitlement monthly quota reset, the new cycle starts now, and {duration} deducted',
    advanceEntitlementMonthlyFailed: 'Failed to advance plan entitlement monthly cycle'
  },
  ...
  payment: {
    ...
    admin: {
      ...
      weeks: 'weeks',
      months: 'months',
      invalidValidityUnitLabel: 'invalid unit ({unit})',
      invalidValidityUnitOption: 'invalid unit ({unit})',
      invalidValidityUnitHint: 'This plan currently stores an invalid validity unit: {unit}. Pick a supported unit before saving.',
      invalidValidityUnitMessage: 'Invalid plan validity unit: {unit}',
      ...
      explicitGroups: 'Explicit Groups',
      platformSubscriptionGroups: 'Platform Subscription Groups',
      allSubscriptionGroups: 'All Subscription Groups',
      authorizedGroups: 'Authorized Groups',
      clearAuthorizedGroups: 'Clear',
      allowedPlatforms: 'Allowed Platforms',
      overagePolicy: 'Overage Policy',
      overageBlock: 'Block',
      overageBalanceFallback: 'Balance Fallback',
      groupIdsRequired: 'Select at least one authorized group',
      platformsRequired: 'Select at least one allowed platform',
      priceRequired: 'Price must be greater than 0',
      validityDaysRequired: 'Validity days must be greater than 0',
      limitRequired: 'Limits must be greater than 0, or blank for unlimited',
      weeklyLimitPeriodInvalid: 'The current plan validity is only {days} day(s), so a weekly limit is invalid. Use a daily limit or set validity to at least 7 days.',
      monthlyLimitPeriodInvalid: 'The current plan validity is only {days} day(s), so a monthly limit is invalid. Use a daily/weekly limit or set validity to at least 30 days.',
    ...
    referral: {
      title: 'Referral Management Overview',
      description: 'View global referral accounts, commission trends, and process withdrawals.',
      quickOpenAccountPlaceholder: 'Search account email to open workspace...',
      menuCommission: 'Overview',
      menuWithdrawals: 'Bulk Withdrawal Review',
      availableCommission: 'Currently Withdrawable Total (CNY)',
      fromActiveRelations: 'From {count} bound users',
      pendingCommission: 'Pending Safe-Period Total',
      pendingCommissionHint: 'Pending commissions not yet settled',
      frozenCommissionTitle: 'Frozen Funds',
      pendingQueueCount: '{count} withdrawals pending',
      withdrawnCommission: 'Settled Withdrawal Amount',
      historicalPaidOut: 'Total historically paid out',
      trendTitle: 'Income and Outflow Trend (Last 7 Days)',
      pendingWithdrawalsTitle: 'Quick Review Queue',
      viewAll: 'View All',
      goToProcess: 'Process',
      noPendingRecords: 'No pending records',
      ...
      structureTree: 'Structure Tree',
      workspace: 'Workspace',
      rewardTrendLegend: 'New Referral Commissions',
      withdrawTrendLegend: 'Referral Withdrawal Outflow',
      treeTitle: 'Referral Structure Tree',
      treeRoot: 'Root',
      inviteCode: 'Invite Code',
      ...
      manageThisPerson: 'Manage This User',
      noInviteesYet: 'No invitees yet',
      workspaceTitle: 'User Referral Workspace',
      promoCode: 'Referral Code',
      directDownline: 'Direct Downline',
      totalCommissionOutput: 'Total Commission Output',
      changeReferrerTitle: 'Change Referrer',
      changeReferrerDesc: 'Adjust the current user\'s referral relationship',
      currentUpstream: 'Current Referrer',
      organicSignup: 'Organic Signup',
      viewHierarchy: 'View Hierarchy',
      searchNewUpstream: 'Search New Referrer',
      searchByEmailPlaceholder: 'Search users by email',
      willBindTo: 'Will bind to',
      changeReasonLabel: 'Change Reason',
      changeReasonPlaceholder: 'Enter the reason for change',
      confirmChangeUpstream: 'Confirm Referrer Change',
      rewardTrackingTitle: 'Commission Tracking',
      rewardTrackingDesc: 'Review commission records and perform manual adjustments',
      noRewardRecords: 'No commission records',
      manualAdjustTitle: 'Manual Adjustment',
      currentSelectedOrder: 'Current Selected Order',
      adjustAmountLabel: 'Adjustment Amount (¥)',
      positiveAddNegativeDeduct: 'Positive to add, negative to deduct',
      adjustRemarkLabel: 'Adjustment Remark',
      adjustReasonPlaceholder: 'Enter adjustment reason',
      executeAdjustment: 'Apply Adjustment',
      selectOrderFirst: 'Select an order first',
      withdrawalRequestRecords: 'Withdrawal Request Records',
      noWithdrawalActions: 'No withdrawal actions',
      accountTrailTitle: 'Account Trail',
      systemChange: 'System Change',
      reasonLabel: 'Reason',
      noDescription: 'No description',
      none: 'None',
      ...
      tabWithdrawalRecords: 'Withdrawal Records',
      tabChangeLog: 'Change Log',
      relationSaved: 'Referrer updated successfully',
      adjustmentSaved: 'Adjustment completed',
      withdrawalReviewTitle: 'Withdrawal Review',
      withdrawalReviewDescription: 'Review and process user commission withdrawal requests',
      withdrawalNo: 'Withdrawal No.',
      withdrawalUser: 'User',
      withdrawalAmount: 'Requested Amount',
      ...
      viewDetails: 'Review',
      noWithdrawalText: 'There are no withdrawal requests to process right now',
      withdrawalItemsTitle: 'Withdrawal Audit',
      userInfo: 'User Info',
      username: 'Username',
      withdrawalDetails: 'Withdrawal Details',
      payoutAccountNo: 'Payout Account',
  ...
  referral: {
    ...
    convertToCredit: 'Convert commission to platform balance',
    convertDesc: 'Funds arrive in your platform balance immediately and can be used for spending.',
    convertAmount: 'Conversion amount',
    convertSuccess: 'Converted to platform balance successfully',
    monetizationDisabledMessage: 'Referral commission balance conversion and withdrawals are currently disabled.',
    withdrawDisabledMessage: 'Referral commission withdrawals are currently disabled.',
    invitees: 'Invitees',
    commissionLog: 'Commission Log',
    ...
    admin: {
      ...
      totalUsers: 'Total Referral Users',
      totalCommission: 'Total Commission',
