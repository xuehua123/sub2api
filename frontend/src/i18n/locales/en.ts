export default {
  ...
  keys: {
    ...
    entitlementLabel: 'Subscription entitlement',
    entitlementSelectPlaceholder: 'Select an entitlement',
    entitlementAutoSelected: 'Selected entitlement',
    entitlementRequired: 'Please select a subscription entitlement for this group',
    entitlementSelectionRequired: 'This group is covered by multiple entitlements. Choose one before saving.',
    entitlementSingleHint: 'This group will use the shown entitlement quota.',
    entitlementMultipleHint: 'Multiple entitlements cover this group. Choose which quota this key should use.',
    entitlementSingleAvailable: '1 entitlement available',
    entitlementMultipleAvailable: '{count} entitlements available',
    entitlementFallbackName: 'Entitlement {id}',
