export default {
  ...
  auth: {
    ...
    lobehub: {
      title: 'Connecting LobeHub',
      continuing: 'Opening LobeHub for you...',
      invalidRequest: 'Invalid LobeHub sign-in request. Please retry from LobeHub.',
      continueFailed: 'Unable to continue to LobeHub. Please try again later.',
      selectKeyTitle: 'Select Chat API Key',
      selectKeyDescription: 'Choose the API key LobeHub should use for chat.',
      noKeys: 'No active API keys are available. Create one first.',
  ...
  admin: {
    ...
    settings: {
      ...
      lobehub: {
        ...
        enabledHint: 'Show launch entry points and enable the OIDC provider.',
        chatUrl: 'Chat URL',
        chatUrlPlaceholder: 'https://chat.example.com',
        chatUrlHint: 'Public LobeHub chat domain.',
        oidcIssuer: 'OIDC Issuer',
        oidcIssuerPlaceholder: 'https://api.example.com',
        oidcIssuerHint: 'Issuer used by LobeHub generic OIDC.',
        clientId: 'OIDC Client ID',
        clientIdPlaceholder: 'sub2api-lobehub',
        clientIdHint: 'Must match the LobeHub env configuration.',
        clientSecret: 'OIDC Client Secret',
        clientSecretPlaceholder: 'Enter a client secret',
        clientSecretConfiguredPlaceholder: 'Leave blank to keep current client secret',
        clientSecretHint: 'Used by the token endpoint.',
        clientSecretConfiguredHint: 'Leave blank to keep the existing secret, fill to rotate it.',
        defaultProvider: 'Default Provider',
        defaultProviderHint: 'Provider name used in imported settings.',
        defaultModel: 'Default Model',
        defaultModelPlaceholder: 'gpt-5.4-mini',
        defaultModelHint: 'Optional default model passed to LobeHub settings.',
        runtimeConfigVersion: 'Runtime Config Version',
        runtimeConfigVersionPlaceholder: '2026-04-07',
        runtimeConfigVersionHint: 'Bump this whenever import behavior changes so chat bootstrap refreshes.',
        hideImportButton: 'Hide import button',
        hideImportButtonHint: 'Hide the user-side LobeHub launch action.'
      },
