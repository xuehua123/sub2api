export default {
    accounts: {
      ...
      upstreamMultiplierSync: {
        loading: 'Loading',
        loadingTitle: 'Loading the upstream multiplier observation status.',
        loadFailed: 'Load failed',
        loadFailedTitle: 'Upstream connection data could not be loaded, so this account rate cannot be verified.',
        unbound: 'Not bound',
        unboundTitle: 'This account is not bound to a shared upstream connection, so its rate cannot be verified.',
        pending: 'Pending',
        pendingTitle: 'The account is bound, but its upstream multiplier observation has not completed. Connection: {connection}',
        unresolved: 'Unresolved',
        unresolvedTitle: 'The upstream connection is synchronized, but this API key\'s upstream group could not be resolved. Connection: {connection}',
        failed: 'Sync failed',
        failedTitle: 'Upstream multiplier synchronization failed. Connection: {connection}; Error: {error}',
        multiplierUnavailable: 'No multiplier',
