export default {
    accounts: {
      ...
      upstreamRateSync: {
        ...
        description: 'Uses an upstream user-management identity to sync this account\'s group rate every 5 minutes. Scheduling priority changes only when global automatic sorting is enabled.',
        group: 'Upstream Group',
        groupPlaceholder: 'e.g. plus',
        groupHint: 'Detect the upstream first, then choose one of the groups returned for this account.',
        groupRequired: 'Detect and choose an upstream group before enabling rate sync',
        groupSelectPlaceholder: 'Detect upstream groups first',
        discover: 'Detect and load groups',
        discovering: 'Detecting...',
        discoverSuccess: 'Upstream detected and groups loaded',
