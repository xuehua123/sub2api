export default {
    availableChannels: {
      ...
      pricing: {
        ...
        billingModeVideo: 'Per Second',
        inputPrice: 'Input',
        outputPrice: 'Output',
        cacheWritePrice: 'Cache Write',
		cacheWrite5mPrice: 'Cache Write (5m)',
		cacheWrite1hPrice: 'Cache Write (1h)',
		accountLongContextRequired: ' (requires account long-context billing)',
    ...
    channels: {
      ...
      form: {
        ...
        perRequestPriceRequired: 'A default price or billing tier is required for per-request, image, and video billing modes',
        tierLabel: 'Tier',
