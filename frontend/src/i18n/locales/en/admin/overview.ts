export default {
    ...
    backup: {
      ...
      actions: {
        ...
        downloadPartsHint: 'Download every part in order and concatenate the gzip bytes: on Linux/macOS run cat payload.part-* > backup.sql.gz; on Windows run {windowsCommand}.',
    ...
    users: {
      ...
      restrictPublicGroupsHint: 'When on, this user may only use the public groups checked below. If exclusive-only mode is also on, public groups remain unavailable.',
      publicGroupsRestricted: 'Public Groups (Restricted)',
      publicGroupsExclusiveOnly: 'Unavailable in exclusive-only mode',
