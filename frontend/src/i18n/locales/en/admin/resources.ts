export default {
    ...
    announcements: {
      ...
      form: {
        ...
        searchTargetUsers: 'Search by email or username...',
        selectTargetUsers: 'Select at least one recipient',
      ...
      targetingSummaryUsers: 'Specific users ({users})',
  ...
  referral: {
    ...
    menuRewards: 'Commission Details',
    ...
    rewardsSearch: 'Search referrer / invitee',
    rewardsSearchPlaceholder: 'Email / username',
    referrerUser: 'Referrer (earns)',
    inviteeUser: 'Invitee (recharged)',
    level: 'Level',
