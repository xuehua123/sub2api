export default {
  ...
  keys: {
    ...
    connectivity: {
      ...
      start: 'Start check',
      retry: 'Check again',
      loadingConfig: 'Loading connection check configuration...',
      completeAnnouncement: 'Connection check complete.',
      testing: 'Checking',
      notTested: 'Not checked',
      incomplete: 'Incomplete',
      rateLimited: 'Too frequent',
      recommended: 'Recommended',
      testedAt: 'Checked at {time}',
      disclaimer: 'Results describe only how your current device and network reached each API URL during this check. ISP, location, Wi-Fi, proxy/VPN, and timing can affect the result; it does not represent other users or networks.',
      configUnavailable: 'A valid check configuration is temporarily unavailable. Please try again later.',
      rateLimitedMessage: 'Checks are being requested too frequently. Please try again later.',
      incompleteMessage: 'This check did not finish. Keep this page visible, confirm your network is available, and try again.',
      exitIP: 'Network egress for this check:',
      splitExit: 'Different API URLs used different network egress addresses, possibly due to proxy, VPN, or routing rules.',
      unknownExit: 'Current network egress could not be identified',
      exitIPHint: 'The egress IP is only the public address seen by this API URL during this check. A proxy, VPN, or routing rule may change it.',
      networkSection: 'Current device network',
      publicEgress: 'Public egress:',
      ipLocation: 'IP location:',
      estimated: '(estimated)',
      typicalLatency: 'Typical latency {ms} ms',
      noLatency: 'No latency available',
      unknownRegion: 'Region unknown',
      latencyNote: 'Results describe how your current device and network reached each API URL during this check. Latency is not model response speed, and the IP location is not where the server is located.',
      grades: {
        excellent: 'Excellent',
        good: 'Good',
        fair: 'Fair',
      ...
      messages: {
        excellent: 'Your current network reached this API URL with excellent results. Recommended.',
        good: 'Your current network reached this API URL with good results. It is suitable to use.',
        fair: 'Your current network can reach this API URL, but the experience may vary.',
        not_recommended: 'For your current network, consider choosing another API URL.',
      },
    },
