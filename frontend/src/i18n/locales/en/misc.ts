export default {
  ...
  payment: {
    ...
    referral: {
      ...
      withdrawalAmount: 'Requested',
      withdrawalFee: 'Fee',
      withdrawalNet: 'Net / credited',
  ...
  referral: {
    ...
    walletCardTitle: 'Cash out anytime',
    walletCardDesc: 'Settled balance can be withdrawn; processing funds need to clear first.',
    walletCardDescWithRate: 'Earn {pct}% on invites. Withdraw or convert after settlement.',
