export default {
  ...
  userSubscriptions: {
    lifecycle: {
      ...
      autoLabel: 'Use the next month early when quota runs out',
      autoHint: 'When monthly quota runs out, the next eligible request starts a prepaid cycle. No automatic payment.',
      autoEnabled: 'On',
      autoDisabled: 'Off',
      autoValidityHint: 'Starting early moves the plan expiry forward by the same time. Daily and weekly limits stay unchanged.',
      autoWaiting: 'Enabled; renew to add enough validity for a future cycle.',
      futureAvailable: 'Next-cycle quota is available', futureUnavailable: 'No full next cycle is available yet', currentExpiry: 'Current plan expiration', history: 'Plan history', loadMore: 'Load earlier records', emptyHistory: 'No changes recorded yet', acknowledge: 'Got it',
    ...
    switchPriorityHint: 'Drag subscription groups to reorder fallback candidates. API keys keep using their current group, and only switch top-down within the same platform and type when that group is unavailable or out of quota.',
    switchPrioritySaved: 'Auto-switch priority saved',
    switchPrioritySaveFailed: 'Failed to save auto-switch priority',
    switchCandidateToggleHint: 'Whether this group can be used as an auto-switch fallback. This does not stop an API key from using its current group first.',
    switchMode: {
    ...
    advanceEntitlementMonthlyCycle: 'Use next month’s quota early',
  ...
  payment: {
    ...
    processingCommission: 'Commission processing',
    accountCoolingDown: 'This account is cooling down. Wait until the cooldown ends before editing.',
    accountEditableNow: 'Editable now',
    accountName: 'Payee name',
    accountNextEditableAt: 'Editable after {time}',
    accountSaved: 'Payout account saved',
    accountUpdated: 'Payout account updated',
    addNewAccount: 'Add payout account',
    alipayAccount: 'Alipay account',
    availableToWithdraw: 'Available to withdraw',
    bankCardNo: 'Bank card number',
    bankName: 'Bank name',
    bindTime: 'Linked at',
    dropQrHint: 'Drop an image here or click to select',
    entryType: 'Type',
    hasQrCode: 'Payment QR code',
    imageTooLarge: 'Image must not exceed 2 MB',
    invalidImageType: 'Choose a PNG, JPG or GIF image',
    latestPaidAt: 'Last payment',
    makeDefaultAccount: 'Set as default payout method',
    noPayoutAccountHint: 'Add a payout account on the left first',
    notPaid: 'No recharge yet',
    orderCount: 'Orders',
    payoutAccountsHint: 'Add payout accounts here. Editing an account requires a 7-day cooldown.',
    payoutMethod: 'Payout method',
    qrCode: 'Payment QR code',
    qrUrlPlaceholder: 'Or paste an image URL: https://',
    selectPayoutAccount: 'Payout account',
    submitWithdrawal: 'Confirm withdrawal',
    totalCommissionAmount: 'Total commission',
    totalRecharge: 'Total recharge',
    updateAccount: 'Edit payout account',
    wechatAccount: 'WeChat ID / phone number',
    wechatQrUrl: 'WeChat payment QR code (optional)',
    withdrawAll: 'Withdraw all',
    withdrawAmount: 'Withdrawal amount',
    withdrawInvalid: 'Invalid withdrawal amount',
    withdrawRemark: 'Note (optional)',
    withdrawalCreated: 'Withdrawal request submitted',
    withdrawalHint: 'The amount is reserved on submission and paid after approval.',
      ...
      pendingWithdrawalsTitle: 'Pending cash withdrawals',
      pendingWithdrawalsHint: 'Manual review required',
      recentCreditTitle: 'Recent balance conversions',
      recentCreditHint: 'Self-serve · no review',
      noPendingCash: 'No pending cash withdrawals',
      chipPendingReview: 'Pending',
      chipPendingPayout: 'To pay',
      cashNetLabel: 'Cash net',
      negativeDebtLabel: 'Negative commission debt',
      trendSubtitle: 'Commission in vs withdrawal / conversion out',
      noCreditConversionRecords: 'No balance conversions yet',
      rankingSubtitle: 'Sorted by total commission · second-level counts only (no rebate)',
      directInviteesShort: 'Direct',
      secondLevelShort: 'L2',
      noRebateTag: 'no rebate',
      secondLevelNoRebateHint: 'Second level is counted only; no rebate is paid',
      filterKindAll: 'All types',
      filterKindCash: 'Cash withdrawal',
      filterKindCredit: 'Balance conversion',
      filterStatusAll: 'All statuses',
      filterStatusPending: 'Pending review',
      filterStatusApproved: 'Approved',
      filterStatusPaid: 'Completed',
      filterStatusRejected: 'Rejected',
      filterKindLabel: 'Type',
      filterStatusLabel: 'Status',
      payoutReviewBadge: 'Payout review',
  ...
  referral: {
    home: 'Home',
    accountCoolingDown: 'This payout account is cooling down and cannot be edited yet.',
    accountEditableNow: 'Editable now',
    ...
    dropQrHint: 'Drop an image here or choose a file',
    entryType: 'Entry type',
    hasQrCode: 'Payment QR code added',
    imageTooLarge: 'Image must be no larger than 2 MB',
    invalidImageType: 'Choose a PNG, JPG or GIF image',
    latestPaidAt: 'Last payment',
    makeDefaultAccount: 'Set as default payout account',
    noPayoutAccountHint: 'Add a payout account first',
    notPaid: 'No payment yet',
    orderCount: 'Orders',
    payoutAccountsHint: 'Add a payout account. Existing accounts require a 7-day cooldown before editing.',
    payoutMethod: 'Payout method',
    processingCommission: 'Commission processing',
    qrCode: 'Payment QR code',
    qrUrlPlaceholder: 'Or paste an image URL https://',
    ...
    totalCommission: 'Total commission',
    totalCommissionAmount: 'Commission earned',
    totalRecharge: 'Total recharge',
    updateAccount: 'Edit payout account',
    wechatAccount: 'WeChat account',
    wechatQrUrl: 'WeChat payment QR URL',
    withdrawAll: 'Withdraw all',
    withdrawAmount: 'Withdrawal amount',
    withdrawInvalid: 'Enter a valid amount and choose a payout account',
    withdrawRemark: 'Remark (optional)',
    withdrawalCreated: 'Withdrawal request submitted',
    withdrawalHint: 'The requested amount is reserved on submission and paid after approval.',
    withdrawalNo: 'Withdrawal reference',
    withdrawnCommission: 'Withdrawn commission',
    title: 'Invite & Rewards',
    description: 'Share your link and earn rewards when friends recharge.',
    enabled: 'Invite & Rewards',
    ...
    heroEyebrow: 'Invite & Rewards',
    heroTitle: 'Invite friends',
    heroHighlight: 'earn rewards',
    heroSubtitle: 'Share your link. When friends recharge, you earn commission. Withdraw cash or convert to balance.',
    heroSubtitleWithRate: 'Friends who register and recharge via your link can earn you about {pct}% commission.',
    shareCardEyebrow: 'Your invite',
    shareCardTitle: 'Share and start earning',
    shareCardTitleNoCommission: 'Share your invite link',
    shareCardDesc: 'Copy your link — friends register and recharge to generate commission.',
    shareCardDescNoCommission: 'Copy your invite link. No commission rate is configured, so recharges will not earn invite rewards.',
    shareCardDescWithRateFirst: 'Earn {pct}% on a friend’s first successful recharge · copy link to share',
    shareCardDescWithRateEvery: 'Earn {pct}% on every successful recharge · copy link to share',
    walletCardEyebrow: 'Earnings',
    walletCardTitle: 'Available to withdraw',
    walletCardTitleConvertOnly: 'Available to convert',
    walletCardTitleBalanceOnly: 'Commission balance',
    walletCardDesc: 'Settled funds can be withdrawn; processing funds need to clear first.',
    walletCardDescWithdrawOnly: 'Settled funds can be withdrawn; processing funds need to clear first.',
    walletCardDescConvertOnly: 'Settled funds can be converted to platform balance; processing funds need to clear first.',
    walletCardDescDisabled: 'Withdrawals and conversion are both off; you can still view commission history.',
    walletCardDescWithRate: 'Earn {pct}% on invites. After settlement you can withdraw or convert.',
    walletCardDescWithRateWithdrawOnly: 'Earn {pct}% on invites. After settlement you can withdraw.',
    walletCardDescWithRateConvertOnly: 'Earn {pct}% on invites. After settlement you can convert to balance.',
    defaultCode: 'Invite code',
    inviteLink: 'Invite link',
    clickToViewDetail: 'View details',
    withdrawal: 'Withdraw',
    invitedCount: '{n} invited',
    rateChip: '{pct}% on recharges',
    bucketDetailTruncated: 'Showing at most {max} ledger rows. Open the Ledger tab for the full list.',
    rateBanner: {
      live: 'Invite & Rewards is live',
      title: 'Invite friends to recharge',
      titleEarn: 'earn commission',
      titleDisabled: 'Invites available · level-1 commission is off',
      titleNoRate: 'Invite friends · no commission rate configured',
      headlineBefore: 'Friends recharge, you earn',
      headlineAfter: 'commission',
      rateLabel: 'Current commission rate',
      perRechargeEvery: 'On every successful recharge',
      perRechargeFirst: 'On the first successful recharge',
      perRechargeDisabled: 'Level-1 commission is currently off',
      ratePending: 'Rate is set by the platform. Examples appear once configured.',
      rateDisabled: 'Level-1 commission is disabled; invites will not earn commission.',
      subtitle: 'Share your link. When friends recharge, you earn commission.',
      subtitleNoRate: 'Share your link. Commission rate is 0, so recharges will not earn invite rewards.',
      subtitleDisabled: 'Level-1 commission is off. You can still share, but recharges will not earn commission.',
      subtitleFirst: 'Share your link. On a friend’s first successful recharge you earn {pct}% (withdrawable after settlement).',
      subtitleEvery: 'Share your link. On every successful recharge you earn {pct}% (withdrawable after settlement).',
      subtitleFirstWithDelay: 'Share your link. First successful recharge earns {pct}%; withdrawable after about {days} days.',
      subtitleEveryWithDelay: 'Share your link. Every successful recharge earns {pct}%; withdrawable after about {days} days.',
      exampleTitle: 'Examples',
      friendPaysFirst: 'First pay',
      friendPaysEvery: 'Pays',
      youEarn: 'You',
      footnote: 'Rate and mode follow platform rules at order time.',
      footnoteDelay: 'Withdrawable about {days} days after booking. Rate and mode follow rules at order time.',
      bulletPermanent: 'Permanent invite link',
      bulletAutoFirst: 'Booked on first successful recharge',
      bulletAutoEvery: 'Booked on every successful recharge',
      bulletNoRate: 'Rate is 0 · no commission booked',
      bulletDisabled: 'Level-1 commission off',
      bulletCashAndCredit: 'Cash out · convert to balance',
      bulletWithdraw: 'Cash withdrawals supported',
      bulletCredit: 'Convert to platform balance',
    },
    chips: {
      permanentCode: 'Permanent code',
      rechargeRebate: 'Earn on recharges',
      withdraw: 'Cash out',
      credit: 'Convert to balance',
      settlementDays: '{days}-day settlement',
    },
    howItWorksTitle: 'Earn in 3 steps',
    howItWorks: {
      step1Title: 'Share your link',
      step1: 'Copy your invite link or code and send it to friends.',
      step2Title: 'They register & pay',
      step2TitleDisabled: 'Commission rules',
      step2TitleNoCommission: 'Commission rules',
      step2TitleFirstWithRate: 'First recharge · {pct}%',
      step2TitleEveryWithRate: 'Every recharge · {pct}%',
      step2: 'When friends recharge successfully, commission is booked for you.',
      step2Disabled: 'Level-1 commission is disabled; recharges will not earn invite commission.',
      step2NoCommission: 'Commission rate is 0 or not configured; recharges will not earn invite commission.',
      step2FirstWithRate: 'On the first successful recharge, you earn {pct}%.',
      step2EveryWithRate: 'On every successful recharge, you earn {pct}%.',
      step2WithDelay: 'Commission is booked on recharge and becomes withdrawable after about {days} days.',
      step2FirstWithRateAndDelay: 'First successful recharge earns {pct}%; withdrawable after about {days} days.',
      step2EveryWithRateAndDelay: 'Every successful recharge earns {pct}%; withdrawable after about {days} days.',
      step3Title: 'Withdraw or convert',
      step3WithdrawTitle: 'Withdraw cash',
      step3CreditTitle: 'Convert to balance',
      step3PendingTitle: 'Payout pending',
      step3Both: 'Cash out after review.',
      step3Withdraw: 'Submit a withdrawal; paid to your payout account after review.',
      step3Credit: 'Convert 1:1 to platform balance for spending.',
      step3CreditMulti: 'Convert at ×{rate} to platform balance for spending.',
      step3Pending: 'Commission is booked; payout methods will open later.',
    },
    creditConversionRateOneToOne: '1 commission = 1 balance',
    creditConversionRateMulti: '1 commission = {rate} balance',
    creditConversionExample: 'Example: convert ¥{in} → credit ¥{out}',
    convertToCreditMulti: 'Convert · ×{rate}',
    convertModalAll: 'All',
    convertModalExpected: 'Expected balance credit',
    convertModalRateTitle: 'Conversion rate',
    convertPrecisionNote: '(same precision as settlement, up to 8 decimals)',
    recordsTitle: 'Activity details',
    recordsSubtitle: 'Invitees, commissions, ledger and withdrawals',
    tabs: {
      invitees: 'Invitees',
      rewards: 'Rewards',
      ledger: 'Ledger',
    ...
    empty: {
      inviteTitle: 'No invitees yet',
      inviteHint: 'Copy your invite link above. After friends register and recharge, details show here.',
      inviteCta: 'Copy invite link',
    },
    typeLabel: 'Type',
    withdrawalRecordsHint: 'Includes cash withdrawals and balance conversions. Conversions are not bank payouts.',
    convertToCredit: 'Convert to balance',
    convertDesc: 'Funds arrive in your platform balance immediately and can be used for spending.',
    convertAmount: 'Amount (commission)',
    convertSuccess: 'Converted to platform balance successfully',
    creditConversionRateLabel: 'Conversion rate',
    creditConversionRate: 'Conversion multiplier',
    expectedCreditAmount: 'Expected credit',
    ...
    noRewards: 'No commission bookings yet',
    rewardsTitle: 'Commission Booking Details',
    rewardsDescription: 'Commission rows booked when invited users successfully recharge. One row per order.',
    rewardDate: 'Booked at',
    ...
    withdrawalRecords: 'Withdrawal & credit conversion records',
    partialLoadFailed: 'Some sections failed to load: {sections}',
    rewardPendingCredit: 'Commission credited',
    rewardSettled: 'Commission settled',
    withdrawFreeze: 'Withdrawal freeze',
    withdrawReturn: 'Withdrawal returned',
    withdrawPaid: 'Withdrawal / conversion completed',
    adminAdd: 'Admin credit',
    adminSubtract: 'Admin debit',
    status: {
      pending: 'Pending',
