export default {
  ...
  referral: {
    accountCoolingDown: 'accountCoolingDown',
    accountEditableNow: 'accountEditableNow',
    accountName: 'accountName',
    accountNextEditableAt: 'accountNextEditableAt',
    ...
    dropQrHint: 'dropQrHint',
    entryType: 'entryType',
    hasQrCode: 'hasQrCode',
    imageTooLarge: 'imageTooLarge',
    invalidImageType: 'invalidImageType',
    latestPaidAt: 'latestPaidAt',
    makeDefaultAccount: 'makeDefaultAccount',
    noPayoutAccountHint: 'noPayoutAccountHint',
    notPaid: 'notPaid',
    orderCount: 'orderCount',
    payoutAccountsHint: 'payoutAccountsHint',
    payoutMethod: 'payoutMethod',
    processingCommission: 'processingCommission',
    qrCode: 'qrCode',
    qrUrlPlaceholder: 'qrUrlPlaceholder',
    selectPayoutAccount: 'selectPayoutAccount',
