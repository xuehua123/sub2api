export default {
  ...
  referral: {
    ...
    shareCardDescWithRate: 'Earn {pct}% when friends recharge · copy link to share',
    ...
    rateBanner: {
      ...
      perRecharge: 'On each successful recharge',
      ...
      subtitleWithRate: 'Share your link. When friends recharge, you earn {pct}% (withdrawable after settlement).',
      subtitleWithRateAndDelay: 'Share your link. You earn {pct}% when friends recharge; withdrawable after about {days} days.',
      exampleTitle: 'Examples',
      friendPays: 'Pays',
      youEarn: 'You',
      footnote: 'Actual rate follows platform rules at order time.',
      footnoteDelay: 'Withdrawable about {days} days after booking. Rate follows rules at order time.',
      bulletPermanent: 'Permanent invite link',
      bulletAuto: 'Auto-booked on recharge',
    ...
    howItWorks: {
      ...
      step2TitleWithRate: 'They recharge · you earn {pct}%',
      step2: 'When friends recharge successfully, commission is booked for you.',
      step2WithRate: 'When friends recharge, you earn {pct}% commission.',
      step2WithDelay: 'Commission is booked on recharge and becomes withdrawable after about {days} days.',
      step2WithRateAndDelay: 'You earn {pct}% on recharge; withdrawable after about {days} days.',
