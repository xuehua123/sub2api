export default {
  ...
  keys: {
    ...
    changeGroup: '切换分组',
    accessSourceLabel: '权益来源',
    accessSourceColumn: '权益来源',
    accessSourceBalance: '余额权益',
    accessSourceBalanceShort: '余额',
    accessSourceBalanceHint: '使用账户余额扣费，不绑定套餐权益。',
    accessSourceEntitlement: '套餐权益',
    accessSourceEntitlementHint: '使用所选套餐权益的共享额度。',
    accessSourceNoEntitlementHint: '暂无可用套餐权益',
    accessSourceSwitchRequired: '请先选择权益来源，再切换到这个分组。',
    balanceDeductionHint: '使用账户余额扣费',
    switchAccessSourceShort: '切换来源',
