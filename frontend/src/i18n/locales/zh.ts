export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    currentGroupLabel: '当前分组/倍率',
    changeGroup: '切换分组',
    accessSourceLabel: '额度选择',
    accessSourceColumn: '额度选择',
    accessSourceBalance: '余额',
    accessSourceBalanceShort: '余额',
    accessSourceBalanceHint: '使用账户余额按用量扣费。',
    accessSourceEntitlement: '套餐订阅',
    accessSourceEntitlementHint: '使用已购买套餐订阅的共享额度。',
    accessSourceNoEntitlementHint: '暂无可用套餐订阅',
    accessSourceSwitchRequired: '请先选择额度来源，再切换到这个分组。',
    balanceDeductionHint: '使用账户余额扣费',
    switchAccessSourceShort: '切换额度',
    switchEntitlement: '切换套餐卡',
    planCardBadge: '套餐卡',
    ...
    clickToChangeEntitlement: '切换这把密钥消耗的套餐卡',
    noEntitlement: '未选择套餐卡',
    entitlementLabel: '套餐订阅卡',
    entitlementSelectPlaceholder: '选择套餐卡',
    entitlementAutoSelected: '已选择套餐卡',
    entitlementRequired: '请选择这把密钥要消耗的套餐卡',
    entitlementSelectionRequired: '这个分组包含在多张套餐卡里，请先选择要消耗哪张卡。',
    entitlementChooseFirstHint: '先选择这把密钥要消耗哪张套餐卡，再从这张卡包含的分组里选择当前分组。',
    entitlementSelectedHint: '这把密钥会消耗所选套餐卡的共享额度。',
    currentGroupFilteredHint: '这里只显示当前套餐卡包含的分组；不同分组会按各自倍率消耗这张卡的额度。',
    currentGroupRateHint: '按 {rate} 消耗套餐卡额度',
    entitlementSingleHint: '此分组将使用上方套餐卡的共享额度。',
    entitlementMultipleHint: '多张套餐卡包含此分组，请选择此密钥要消耗哪张卡。',
    entitlementSingleAvailable: '1 张套餐卡包含此分组',
    entitlementMultipleAvailable: '{count} 张套餐卡包含此分组',
    entitlementCurrentCardIncludesGroup: '当前套餐卡包含此分组',
    entitlementFallbackName: '套餐卡 {id}',
    entitlementPlan: '套餐 #{id}',
    entitlementIncludedGroups: '包含 {count} 个分组',
    entitlementExpires: '到期 {date}',
  ...
  admin: {
    ...
    users: {
      ...
      userEnabled: '用户已启用',
      userDisabled: '用户已禁用',
      referralGlobalEnabled: '全局开启',
      referralUserEnabled: '单独开启',
      referralDisabled: '关闭',
      enableReferral: '开返佣',
      disableReferral: '关返佣',
      referralEnabledSuccess: '已为该用户开启返佣',
      referralDisabledSuccess: '已为该用户关闭返佣',
      failedToToggleReferral: '切换返佣权限失败',
    ...
    groups: {
      ...
      capabilities: {
        title: '额度来源开关',
        hint: '控制 API Key 能否通过余额或套餐订阅使用此分组。套餐额度在“订阅套餐管理”里配置。',
        balanceEnabled: '余额权益可用',
        balanceEnabledHint: '选择余额权益的 API Key 可以使用此分组，并从用户余额扣费。',
        subscriptionEnabled: '套餐权益可用',
        subscriptionEnabledHint: '套餐卡可以把此分组作为授权分组，用户购买后即可使用。',
        planAutoGrantEnabled: '自动纳入套餐范围',
        planAutoGrantEnabledShort: '自动纳入',
        planAutoGrantEnabledHint: '当套餐选择“全部订阅分组”或“按平台授权”时，这个分组会自动包含进去。',
        planAutoGrantDisabledHint: '需要先开启套餐权益可用，并且分组为公开、状态正常。',
    ...
    subscriptions: {
      ...
      planHint: '选择套餐后会自动使用套餐绑定的权益分组和有效期',
      validityHint: '默认使用套餐有效期，可按测试需要调整',
      planValidityDays: '{days} 天',
      planId: '套餐 ID #{id}',
      ...
      adjustHint: '输入正数延长套餐，负数缩短套餐（缩短后剩余天数需大于0）',
      assign: '分配',
      assigning: '分配中...',
      adjust: '调整',
      adjusting: '调整中...',
      ...
      cycleAdjustment: '周期调整',
      cycleAdjustmentTitle: '调整额度周期',
      cycleAdjustmentFor: '为以下用户调整周期',
      cycleAdjustmentMode: '调整方式',
      cycleAdjustmentModes: {
        advanceNextCycle: '提前使用下月额度',
        compensateReset: '客服补偿刷新额度',
        alignToReset: '以重置时间为准',
        alignToExpiry: '以到期时间为准',
        custom: '自定义周期'
      },
      cycleAdjustmentModeHints: {
        advance_next_cycle: '与用户侧按钮一致：月用量归零、月窗口从现在开始，并扣掉距离原下次重置的剩余时间。',
        compensate_reset: '只刷新月额度和重置时间，不扣有效期；用于支付/回调异常后的客服补偿。',
        align_to_reset: '保持当前月度窗口锚点，根据周期数重新计算到期时间。',
        align_to_expiry: '保持当前到期时间，根据周期数反推月度窗口开始时间。',
        custom: '手动指定月度窗口开始时间和到期时间。'
      },
      cycleCount: '周期数',
      cycleCountHint: '1 个周期按 30 天计算；多月套餐建议填实际剩余完整周期数。',
      customMonthlyWindowStart: '月度窗口开始',
      customExpiresAt: '到期时间',
      resetMonthlyUsage: '清空月用量',
      resetMonthlyUsageForcedHint: '该模式会刷新额度，因此必须清空月用量。',
      resetMonthlyUsageOptionalHint: '只在本次调整需要同时刷新月额度时开启。',
      cycleAdjustmentReason: '操作原因',
      cycleAdjustmentReasonPlaceholder: '例如：支付回调异常补偿、客服核对后对齐周期',
      previewAdjustment: '预览变更',
      previewing: '预览中...',
      applyCycleAdjustment: '执行调整',
      applyingCycleAdjustment: '执行中...',
      cycleAdjustmentApplied: '周期调整成功',
      failedToPreviewCycleAdjustment: '预览周期调整失败',
      failedToApplyCycleAdjustment: '执行周期调整失败',
      beforeAdjustment: '调整前',
      afterAdjustment: '调整后',
      expiresAt: '到期时间',
      monthlyWindowStart: '月度窗口开始',
      nextResetAt: '下次重置时间',
      monthlyUsage: '月用量',
      deductedValidity: '扣减有效期',
      fullCycles: '完整周期',
      tailDuration: '尾差',
      durationZero: '0 分钟',
      ...
      cycleCountRequired: '请输入有效的周期数',
      cycleCountOutOfRange: '周期数不能超过 {max}',
      customTimesRequired: '请选择自定义月度窗口开始时间和到期时间',
      cycleAdjustmentReasonRequired: '补偿刷新额度必须填写操作原因',
      cycleAdjustmentReasonTooLong: '操作原因不能超过 {max} 个字符',
      cycleAdjustmentUnavailable: {
        generic: '当前套餐不能执行该调整',
        inactive_subscription: '当前套餐未处于可调整状态',
        expired_subscription: '当前套餐已过期或尚未开始',
        monthly_limit_required: '当前套餐没有月度额度限制，不能提前使用下月额度',
        monthly_usage_not_exhausted: '月用量未达到 90%，不能提前使用下月额度',
        invalid_reset_window: '当前月度重置窗口无效',
        no_future_monthly_cycle: '有效期不足以覆盖下一个完整 30 天周期',
        reason_required: '必须填写操作原因',
        custom_times_required: '必须填写自定义时间',
        monthly_window_start_in_future: '月度窗口开始时间不能在未来',
        expires_at_not_in_future: '到期时间必须晚于当前时间',
        expires_at_must_be_after_window_start: '到期时间必须晚于月度窗口开始时间',
        cycle_count_out_of_range: '周期数超出系统支持范围',
        expires_at_after_max: '到期时间不能晚于系统最大上限',
        reason_too_long: '操作原因过长'
      },
      cycleAdjustmentWarnings: {
        compensate_reset_does_not_deduct_validity: '补偿刷新不会扣减有效期，请确认这是客服补偿场景。',
        monthly_usage_will_reset: '执行后月用量会归零。',
        expires_at_will_extend: '执行后到期时间会延长。',
        expires_at_will_shorten: '执行后到期时间会缩短。'
      },
      noSubscriptionsYet: '暂无套餐分配',
      assignFirstSubscription: '分配一个套餐以开始使用。',
      subscriptionAssigned: '套餐分配成功',
      subscriptionAdjusted: '套餐调整成功',
      subscriptionRevoked: '套餐撤销成功',
      failedToLoad: '加载套餐分配列表失败',
      failedToAssign: '分配套餐失败',
      failedToAdjust: '调整套餐失败',
      failedToRevoke: '撤销套餐失败',
      subscriptionRestored: '套餐已恢复',
      failedToRestore: '恢复套餐失败',
      adjustWouldExpire: '调整后剩余天数必须大于0',
      adjustOutOfRange: '调整天数必须在 -36500 到 36500 之间',
      pleaseSelectUser: '请选择用户',
      pleaseSelectGroup: '请选择分组',
      pleaseSelectPlan: '请选择套餐',
      selectedPlanUnavailable: '当前套餐没有可分配的订阅分组',
    ...
    accounts: {
      ...
      openaiHttpProtocol: 'OpenAI 上游 HTTP 协议',
      openaiHttpProtocolDesc: '控制该 OpenAI 账号转发上游时使用默认全局策略、HTTP/1.1 或 HTTP/2。HTTP/1.1 会打开更多 TCP 连接，适合规避 HTTP/2 复用导致的首 token 长尾。',
      openaiHttpProtocolDefault: '默认（跟随全局）',
    ...
    usage: {
      ...
      entitlementId: '权益ID',
      entitlementIdPlaceholder: '精确权益ID',
      billingSource: {
        label: '扣费来源',
        balance: '余额扣费',
        legacy_subscription: '旧套餐',
        entitlement_quota: '权益额度',
        entitlement_balance_fallback: '权益超额余额兜底',
      },
      ipAddress: 'IP',
    ...
    settings: {
      ...
      referral: {
        title: '推荐返佣设置',
        description: '配置推荐返佣系统',
        enableReferral: '启用推荐返佣',
        enableReferralDesc: '允许用户通过邀请他人赚取佣金',
        level1Enabled: '启用一级返佣',
        level1Rate: '一级佣金比例',
        rateHint: '0-1，如 0.1 表示 10%',
        rewardMode: '奖励模式',
        rewardModeFirstPaidOrder: '仅首笔付费订单',
        rewardModeEveryPaidOrder: '每笔付费订单',
        settlementDelayDays: '结算延迟（天）',
        settlementCurrency: '结算货币',
        allowManualInput: '允许手动输入推荐码',
        allowManualInputDesc: '允许用户在注册后手动输入推荐码绑定',
        bindBeforeFirstPaidOnly: '仅首次付款前可绑定',
        bindBeforeFirstPaidOnlyDesc: '仅允许用户在首次付款前绑定推荐人',
        withdrawEnabled: '启用提现',
        withdrawEnabledDesc: '允许用户提现推荐佣金',
        creditConversionEnabled: '启用转余额',
        creditConversionEnabledDesc: '允许用户将可用返佣直接转入平台余额。',
        withdrawMinAmount: '最低提现金额',
        withdrawMaxAmount: '最高提现金额',
        withdrawDailyLimit: '每日提现次数限制',
        withdrawFeeRate: '提现手续费率',
        withdrawFixedFee: '固定提现手续费',
        withdrawManualReviewRequired: '提现需人工审核',
        refundReverseEnabled: '退款时回退返佣',
        negativeCarryEnabled: '允许负数结转',
      ...
      lobehub: {
        title: 'LobeHub 集成',
        description: '配置 LobeHub 聊天集成和 OIDC 认证',
        enableLobeHub: '启用 LobeHub',
        enableLobeHubDesc: '为用户启用 LobeHub 聊天集成',
        chatUrl: 'LobeHub 聊天 URL',
        oidcIssuer: 'OIDC 签发者 URL',
        oidcIssuerHint: '通常自动生成为 {api_base_url}/lobehub/oidc',
        oidcClientId: 'OIDC 客户端 ID',
        oidcClientSecret: 'OIDC 客户端密钥',
        oidcClientSecretConfigured: '（密钥已配置）',
        oidcClientSecretPlaceholder: '输入 OIDC 客户端密钥',
        defaultProvider: '默认服务商',
        defaultModel: '默认模型',
        runtimeConfigVersion: '运行时配置版本',
        hideImportButton: '隐藏 LobeHub 导入按钮',
        hideImportButtonDesc: '在用户界面中隐藏 LobeHub 导入按钮',
      },
    ...
    referral: {
      ...
      noInviteesYet: '暂时还没有邀请记录',
      workspaceTitle: '用户分销档案',
      promoCode: '邀请码',
      directDownline: '直属下级',
      totalCommissionOutput: '累计返佣支出',
      changeReferrerTitle: '调整上级关系',
      changeReferrerDesc: '为该用户重新指定上级邀请人，并记录调整原因。',
      currentUpstream: '当前上级',
      organicSignup: '自然注册',
      viewHierarchy: '查看层级',
      searchNewUpstream: '搜索新上级',
      searchByEmailPlaceholder: '输入邮箱搜索新的上级账号',
      willBindTo: '将绑定到',
      changeReasonLabel: '变更原因',
      changeReasonPlaceholder: '请输入本次调整原因',
      confirmChangeUpstream: '确认更换上级',
      rewardTrackingTitle: '返佣追踪',
      rewardTrackingDesc: '查看该账号关联的返佣订单和发放记录。',
      noRewardRecords: '暂无返佣记录',
      manualAdjustTitle: '手动调账',
      currentSelectedOrder: '当前选中订单',
      adjustAmountLabel: '干预金额 (￥)',
      positiveAddNegativeDeduct: '正数增加，负数扣减',
      adjustRemarkLabel: '调账备注',
      adjustReasonPlaceholder: '请输入调账原因',
      executeAdjustment: '执行调账',
      selectOrderFirst: '请先选择订单',
      withdrawalRequestRecords: '提现申请记录',
      noWithdrawalActions: '暂无提现记录',
      accountTrailTitle: '账号变更轨迹',
      systemChange: '系统变更',
      reasonLabel: '原因',
      noDescription: '暂无说明',
      none: '无',
