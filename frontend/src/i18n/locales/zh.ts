export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    entitlementLabel: '套餐权益',
    entitlementSelectPlaceholder: '选择套餐权益',
    entitlementAutoSelected: '已选择权益',
    entitlementRequired: '请选择该分组使用的套餐权益',
    entitlementSelectionRequired: '该分组被多张套餐权益覆盖，请选择一张权益后保存。',
    entitlementSingleHint: '此分组将使用上方套餐权益的共享额度。',
    entitlementMultipleHint: '多张套餐权益覆盖此分组，请选择此密钥要消耗哪张权益额度。',
    entitlementSingleAvailable: '1 张权益可用',
    entitlementMultipleAvailable: '{count} 张权益可用',
    entitlementFallbackName: '权益 {id}',
