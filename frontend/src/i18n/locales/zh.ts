export default {
  ...
  referral: {
    title: '邀请中心',
    description: '查看推广码、邀请关系、返佣流水和提现记录。',
    defaultCode: '默认推广码',
    ...
    notBound: '未绑定',
    boundCode: '绑定推广码',
    bindPlaceholder: '输入推广码完成绑定',
    bindAction: '绑定邀请关系',
    bindSuccess: '推广码绑定成功',
    bindValidating: '正在校验推广码...',
    bindCodeValid: '推广码可用，可以绑定。',
    bindCodeInvalid: '推广码不可用',
    bindPreview: '将绑定到上级账号：{username}（{email}）',
    payoutAccounts: '收款账户',
    payoutAccountsHint: '新增一个默认收款方式后即可发起提现。',
    payoutAccountsWeeklyHint: '收款账户修改限制为每 7 天一次。',
    editingAccount: '正在编辑收款账户',
    accountName: '收款人名称',
    alipayAccount: '支付宝账号',
    wechatAccount: '微信号 / 手机号',
    wechatQrUrl: '微信收款二维码地址（可选）',
    accountNo: '收款账号 / 标识',
    bankName: '银行名称（银行卡时填写）',
    bankCardNo: '银行卡号',
    makeDefaultAccount: '设为默认收款方式',
    saveAccount: '保存收款账户',
    updateAccount: '更新收款账户',
    accountSaved: '收款账户已保存',
    accountUpdated: '收款账户已更新',
    accountEditableNow: '现在可修改',
    accountNextEditableAt: '下次可修改时间 {time}',
    withdrawal: '提现申请',
    withdrawalHint: '可提现佣金会自动按 reward 分摊并冻结。',
    withdrawMaxHint: '当前最多可提 {amount}',
    withdrawTooLarge: '提现金额不能大于可提现佣金',
    withdrawAmount: '提现金额',
    withdrawRemark: '备注（可选）',
    selectPayoutAccount: '选择收款账户',
    ...
    directInvitees: '一级邀请人数',
    dashboardBannerTitle: '邀请返佣已开启',
    dashboardBannerDesc: '查看推广码、返佣流水和提现记录。',
    ...
    availableToWithdraw: '当前最大可提现额度',
    peopleCount: '人',
    myInviteCodeTitle: '我的推广入口',
    myInviteCodeDesc: '将您的专属链接或固定推广码发给朋友。',
    inviteLink: '邀请注册链接',
    noPayoutAccountHint: '请先在左侧添加收款账户',
    addNewAccount: '新增收款账户',
    payoutMethod: '收款方式',
    qrCode: '收款二维码',
    accountCoolingDown: '账户更新冷却中',
    hasQrCode: '收款二维码',
    methods: {
      alipay: '支付宝',
      wechat: '微信',
  ...
  auth: {
    ...
    referralCodeValid: '推广码有效，注册后将绑定邀请关系',
    referralCodeInvalid: '推广码无效',
    referralCodeValidating: '正在验证推广码...',
    referralCodeInvalidCannotRegister: '推广码无效，请检查后重试',
    linuxdo: {
    ...
    lobehub: {
      title: '继续前往 LobeHub',
      ssoDescription: '正在完成 sub2api 单点登录并准备聊天工作区。',
      continuing: '正在完成安全登录和导入流程...',
      retry: '重新继续',
      retryHint: '如果没有自动跳转，可以手动继续。',
      invalidRequest: '这个 LobeHub 续接链接无效或已过期。',
      continueFailed: '继续进入 LobeHub 失败，请稍后重试。',
      selectKeyTitle: '选择聊天默认 Key',
      selectKeyDescription: '请选择 direct-open 进入 LobeHub 时默认使用的 API Key。',
      continueWithKey: '用这把 Key 继续',
      keyRequired: '请先选择一把 API Key。',
      keysLoadFailed: '加载可用 API Key 失败。',
      noKeys: '你还没有可用的 API Key。请先创建一把 Key，然后我们会继续当前聊天流程。',
  ...
  admin: {
    ...
    referral: {
      title: '返佣管理',
      description: '管理邀请关系、佣金奖励和账本流水。',
      withdrawals: '提现审核',
      menuCommission: '返佣管理',
      menuWithdrawals: '提现审核',
      relations: '邀请关系',
      referrer: '邀请人',
      bindCode: '推广码',
      relationSearch: '按用户邮箱搜索并选择要改绑的账号',
      targetAccount: '目标账号',
      targetAccountSearch: '搜索要改绑的账号邮箱',
      upstreamAccount: '上级账号',
      upstreamAccountSearch: '搜索上级账号邮箱',
      fixedCodeHint: '推广码是固定的。先选左侧需要改绑的账号，再填写上级账号的固定推广码。',
      updateRelation: '改绑关系',
      selectUserHint: '先在左侧选择一个用户',
      relationCode: '新的推广码',
      reason: '改绑原因',
      saveRelation: '保存邀请关系',
      relationSaved: '邀请关系已更新',
      viewRelationHistory: '查看关系历史',
      relationHistoryTitle: '关系历史',
      historyOldReferrer: '原上级 ID',
      historyNewReferrer: '新上级 ID',
      historyOldCode: '原推广码',
      historyNewCode: '新推广码',
      rewards: '佣金奖励',
      owner: '佣金归属',
      sourceUser: '充值用户',
      rewardSearch: '按佣金归属账号搜索并选择要调账的记录',
      adjustment: '手工调账',
      adjustSelectionHint: '先在左侧筛选并点选对应账号的一条 reward，调账会记到这条佣金记录下。',
      adjustAccount: '调账账号',
      selectRewardHint: '先在左侧选择一条 reward',
      adjustAmount: '正数加佣金，负数扣佣金',
      adjustRemark: '调账备注',
      submitAdjustment: '提交调账',
      adjustmentSaved: '调账已提交',
      ledger: '佣金账本',
      withdrawalReviewTitle: '提现审核',
      withdrawalReviewDescription: '查看提现分摊明细，执行通过、驳回和打款。',
      approve: '通过',
      reject: '驳回',
      markPaid: '标记打款',
      approveSuccess: '提现单已通过',
      rejectSuccess: '提现单已驳回',
      markPaidSuccess: '提现单已标记打款',
      rejectReasonDefault: '人工驳回',
      withdrawalItemsTitle: '提现明细',
      allocatedAmount: '分摊金额',
      netAllocatedAmount: '净额',
      feeAllocatedAmount: '手续费分摊',
      rechargeOrderId: '充值订单 ID',
      infoArchitecture: '总览找人 / 树结构理解 / 工作台执行',
      overviewTitle: '总览页',
      overviewDesc: '先看整体规模、待处理提现和近 7 天返佣节奏。',
      totalAccountsHint: '有返佣关系或佣金流水的账号',
      totalBoundUsersHint: '当前已形成上下级关系的用户',
      pendingCommissionHint: '还未进入可提现池',
      availableCommissionHint: '当前用户可申请提现',
      frozenCommissionHint: '已进入提现流程，等待审核或打款',
      withdrawnCommissionHint: '已经完成打款结算',
      trendTitle: '近 7 天返佣趋势',
      trendDesc: '同时看新增返佣和提现申请，判断后台当前节奏。',
      lastSevenDays: '最近 7 天',
      rewardShort: '返',
      withdrawShort: '提',
      rewardTrendLegend: '新增返佣',
      withdrawTrendLegend: '提现申请',
      hierarchySummary: '层级',
      commissionSummary: '佣金',
      fixedReferralCode: '固定推广码',
      pendingWithdrawalCount: '待审核笔数',
      pendingWithdrawalAmountLabel: '待审核净额',
      treeDesc: '这里只看两级层级，避免后台一上来就爆炸。',
      treeRoot: '根账号',
      levelOneAccount: '一级账号',
      levelTwoAccounts: '二级账号',
      workspaceTitle: '账号工作台',
      workspaceTabRelation: '关系操作',
      workspaceTabAdjustment: '手工调账',
      workspaceTabHistory: '关系历史',
      workspaceTabWithdrawals: '提现明细',
      relationWorkbenchTitle: '关系操作流',
      relationWorkbenchDesc: '管理员只选择上级账号，固定推广码自动带出，不再手输。',
      relationConfirmTitle: '确认结果',
      selectedUpstream: '将绑定到',
      fixedCodeReadonlyHint: '默认推广码是固定值，这里只展示，不提供编辑入口。',
      adjustmentDesc: '当前工作台已经锁定账号，先选具体 reward，再做正负调账。',
      rewardLevel: '层级',
      rewardSelected: '已选择',
      selectedRewardSummary: '当前选中的 reward',
      relationHistoryDesc: '所有人工改绑和来源变化都留在这里，方便排查。',
      bindCodeChange: '推广码变更',
      withdrawalItemsDesc: '不跳页面，直接在工作台里看当前账号每一笔提现。',
      selectedWithdrawal: '当前提现单',
      selectWithdrawalHint: '先从左侧选择一笔提现单。',
      // Hardcoded Chinese replacements
      fromActiveRelations: '来自 {count} 个活跃返佣关系',
      pendingQueueCount: '待审核队列共 {count} 笔',
      historicalPaidOut: '历史累计已成功打款',
      viewAll: '全部',
      goToProcess: '前往处理',
      noPendingRecords: '当前暂无待处理记录',
      ...
      inviteCode: '邀请码',
      directSlashViral: '直推 / 裂变',
      peopleSuffix: '人',
      totalCommission: '累计佣金',
      codeLabel: '码',
      totalContribution: '总贡献',
      manageThisPerson: '管理此人',
      theirInvitesViral: 'ta的邀请 (裂变层)',
      noInviteesYet: '此账号暂未邀请任何人。',
      promoCode: '推广码',
      directDownline: '直推下线',
      viralNetwork: '裂变网络',
      totalCommissionOutput: '累计产出佣金',
      tabChangeReferrer: '更改推荐人',
      tabCommissionAdjust: '佣金单干预',
      tabWithdrawalRecords: '提现申请记录',
      tabChangeLog: '变更轨迹日志',
      changeReferrerTitle: '更改推荐人 (上级账号)',
      changeReferrerDesc: '修改该用户的邀请来源，变更后新产生的订单将给新上级返佣。',
      currentUpstream: '当前上级',
      organicSignup: '自然注册（无上级）',
      viewHierarchy: '查看层级视图',
      searchNewUpstream: '搜索新上级账号',
      searchByEmailPlaceholder: '输入邮箱搜索...',
      willBindTo: '将绑定到',
      changeReasonLabel: '修改原因 (必填审计项)',
      changeReasonPlaceholder: '例如：客户要求更换上级，工单记录 #1024',
      confirmChangeUpstream: '确认更换上级',
      rewardTrackingTitle: '返佣订单追踪',
      rewardTrackingDesc: '浏览该用户通过下线获取的每一笔返佣入账，或者针对特定订单进行手工打款/扣款。',
      noRewardRecords: '无可追溯的产生佣金记录',
      manualAdjustTitle: '手动增减此笔佣金',
      currentSelectedOrder: '当前选择订单',
      adjustAmountLabel: '干预金额 (￥)',
      positiveAddNegativeDeduct: '正增加，负扣除',
      adjustRemarkLabel: '干预说明信',
      adjustReasonPlaceholder: '干预原因...',
      executeAdjustment: '执行账目修正',
      selectOrderFirst: '请先在左侧选择一笔订单',
      withdrawalRequestRecords: '提现申请单记录',
      noWithdrawalActions: '未有提现动作',
      accountTrailTitle: '账号流转轨迹',
      systemChange: '系统变更',
      reasonLabel: '原因',
      noDescription: '无说明',
      none: '无',
      noChangeRecords: '无任何变更记录',
      viewDetails: '审查明细 / 执行核准',
      noWithdrawalText: '所有的佣金结转请求已经处理完毕，或是系统内暂无提现动作。',
      withdrawalUserEmail: '目标账户归属',
      dossierNo: '卷宗编号',
      poolComposition: '组成池明细',
      paymentSource: '支付源',
      auditNoActions: '卷宗已封存封卷 (LOCKED)'
    },
    ...
    settings: {
      ...
      invitationAccess: {
        title: '准入邀请码',
        description: '控制是否必须通过平台邀请码获得注册资格。'
      },
      registrationPromo: {
        title: '注册优惠码',
        description: '控制用户注册时是否允许使用赠送余额的优惠码。'
      },
      referral: {
        title: '推广返佣',
        description: '配置推广码绑定、返佣奖励、结算延迟和提现规则。',
        enabled: '启用推广返佣',
        enabledHint: '开启独立的推广码、邀请关系和佣金结算能力。',
        level1Enabled: '启用一级返佣',
        level1EnabledHint: '被邀请人的充值是否给直接邀请人返佣。',
        level1Rate: '一级返佣比例',
        rewardMode: '返佣模式',
        rewardModeFirstPaidOrder: '仅首笔实付充值',
        rewardModeEveryPaidOrder: '每笔实付充值',
        settlementDelayDays: '结算延迟天数',
        bindBeforeFirstPaidOnly: '仅允许首充前绑定',
        bindBeforeFirstPaidOnlyHint: '开启后，首笔实付充值后用户侧不再允许自行改绑。',
        allowManualInput: '允许手动填写推广码',
        allowManualInputHint: '注册或允许的后续时机可手动输入推广码。',
        withdrawEnabled: '启用佣金提现',
        withdrawEnabledHint: '允许用户把可提现佣金提交为提现申请。',
        withdrawMinAmount: '最低提现金额',
        withdrawMaxAmount: '单次最高提现金额',
        withdrawDailyLimit: '每日提现次数上限',
        withdrawFeeRate: '提现手续费比例',
        withdrawFixedFee: '提现固定手续费',
        withdrawManualReviewRequired: '提现必须人工审核',
        refundReverseEnabled: '退款自动冲回佣金',
        refundReverseEnabledHint: '退款、拒付或回滚时自动执行佣金冲回。',
        negativeCarryEnabled: '已提现后允许负佣金结转',
        negativeCarryEnabledHint: '已打款场景发生退款时，允许形成后续抵扣的负佣金。',
      ...
      lobehub: {
        title: 'LobeHub 集成',
        description: '配置官方 LobeHub 的 OIDC 登录与 settings 导入行为。',
        enabled: '启用 LobeHub 集成',
        enabledHint: '开启用户侧入口按钮，并启用 sub2api 的 LobeHub OIDC 能力。',
        chatUrl: '聊天域名',
        chatUrlPlaceholder: 'https://chat.example.com',
        chatUrlHint: '官方 LobeHub 对外访问的域名，用于 bridge 跳转与 direct-open 流程。',
        oidcIssuer: 'OIDC Issuer',
        oidcIssuerPlaceholder: 'https://api.example.com',
        oidcIssuerHint: 'LobeHub Generic OIDC 使用的 issuer，必须与模型调用 baseURL 分离。',
        clientId: 'OIDC Client ID',
        clientIdPlaceholder: 'sub2api-lobehub',
        clientIdHint: '需要与 LobeHub 环境变量中的 Generic OIDC client id 保持一致。',
        clientSecret: 'OIDC Client Secret',
        clientSecretPlaceholder: '请输入 client secret',
        clientSecretConfiguredPlaceholder: '已配置，留空则保持不变',
        clientSecretHint: '用于 LobeHub 调用 token 端点。',
        clientSecretConfiguredHint: '当前已配置。留空保持原值，填写新值可立即轮换。',
        defaultProvider: '默认 Provider',
        defaultProviderPlaceholder: 'openai',
        defaultProviderHint: '生成 settings 导入内容时使用的 provider 名称，首版建议保持 openai。',
        defaultModel: '默认模型',
        defaultModelPlaceholder: 'gpt-4.1',
        defaultModelHint: '可选，作为导入到 LobeHub 的默认模型。',
        runtimeConfigVersion: '运行时配置版本',
        runtimeConfigVersionPlaceholder: '2026-04-07',
        runtimeConfigVersionHint:
          '任何会影响导入结果的全局配置变更，都应同步推进这个版本号，用于触发 chat 侧刷新目标配置。',
        hideImportButton: '隐藏导入按钮',
        hideImportButtonHint: '隐藏用户 Keys 页面里的“导入并打开 LobeHub”按钮。'
      },
      purchase: {
        title: '充值/订阅页面',
