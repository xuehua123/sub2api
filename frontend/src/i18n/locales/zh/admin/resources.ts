export default {
    ...
    announcements: {
      ...
      form: {
        ...
        targetingCustom: '按条件',
        targetUsers: '接收用户',
        searchTargetUsers: '按邮箱或用户名搜索用户...',
        selectTargetUsers: '请至少选择一个接收用户',
      ...
      targetingSummaryUsers: '指定用户（{users} 人）',
  ...
  referral: {
    ...
    rewardsTitle: '佣金记账明细',
    rewardsDescription: '邀请用户充值成功后产生的返佣记账，一行对应一笔订单返佣。',
    rewardsSearch: '搜索邀请人/被邀请人',
    rewardsSearchPlaceholder: '邮箱 / 用户名',
    referrerUser: '邀请人（得佣）',
    inviteeUser: '被邀请人（充值）',
    level: '层级',
    availableAt: '可结算时间',
