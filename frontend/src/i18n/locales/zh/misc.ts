export default {
  ...
  payment: {
    ...
    referral: {
    accountCoolingDown: "账户冷却中，必须等待冷却时间过后方可修改。",
    accountEditableNow: "现在可修改",
    accountName: "收款人名称",
    accountNextEditableAt: "{time} 后可修改",
    ...
    noPayoutAccountHint: "请先在左侧添加收款账户",
    notPaid: "未充值",
    orderCount: "订单数",
    payoutAccountsHint: "新增提现账户，修改需要 7 天冷却期。",
    payoutMethod: "收款方式",
    processingCommission: "处理中佣金",
    qrCode: "收款二维码",
    qrUrlPlaceholder: "或粘贴图片链接 https://",
    selectPayoutAccount: "入账账户",
    submitWithdrawal: "确认提现",
    totalCommission: "累计佣金",
    totalCommissionAmount: "返佣总额",
    totalRecharge: "充值总额",
    updateAccount: "编辑收款账户",
    wechatAccount: "微信号 / 手机号",
    wechatQrUrl: "微信收款码 (可选)",
    withdrawAll: "全部提现",
    withdrawAmount: "提现金额",
    withdrawInvalid: "提现金额无效",
    withdrawRemark: "留言备注 (选填)",
    withdrawalCreated: "提现申请已提交",
    withdrawalHint: "发起后锁定金额，审核通过后打款。",
    withdrawalNo: "单号",
