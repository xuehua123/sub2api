export default {
  ...
  referral: {
    ...
    shareCardDescWithRate: '好友充值你拿 {pct}% · 复制链接一键分享',
    ...
    rateBanner: {
      ...
      headlineAfter: '佣金',
      rateLabel: '当前返佣比例',
      perRecharge: '好友每笔成功充值',
      ratePending: '返佣比例以平台设置为准，配置后将显示收益举例。',
      subtitle: '把专属链接发给朋友，他们充值你拿佣金。',
      subtitleWithRate: '把专属链接发给朋友。他们注册并充值后，你按 {pct}% 获得佣金（记入后需结算才可提现）。',
      subtitleWithRateAndDelay: '把专属链接发给朋友。他们充值后你按 {pct}% 记入佣金，约 {days} 天后可提现。',
      exampleTitle: '收益举例',
      friendPays: '充',
      youEarn: '你',
      footnote: '实际比例以订单发生时的平台规则为准。',
      footnoteDelay: '佣金入账约 {days} 天后可提现；比例以订单发生时规则为准。',
    ...
    howItWorks: {
      ...
      step2Title: '好友注册充值',
      step2TitleWithRate: '好友充值 · 返 {pct}%',
      step2: '好友充值成功后，系统自动记入你的佣金。',
      step2WithRate: '好友充值成功后，按 {pct}% 记入佣金。',
      step2WithDelay: '好友充值成功即记佣金，约 {days} 天后可提现。',
      step2WithRateAndDelay: '好友充值成功，你获得 {pct}% 佣金，约 {days} 天后可提现。',
      step3Title: '提现或转余额',
