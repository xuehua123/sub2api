export default {
  ...
  userSubscriptions: {
    lifecycle: {
      ...
      autoLabel: '用完自动使用下期额度',
      autoHint: '月额度用完后，下次调用时提前使用已续费的下期额度。不自动扣款。',
      autoEnabled: '已开启',
      autoDisabled: '已关闭',
      autoValidityHint: '提前几天使用，套餐就提前几天到期；日、周限额不变。',
      autoWaiting: '已开启；后续周期不足，续费后满足条件即自动生效。',
      futureAvailable: '还有下一期额度可用',
      futureUnavailable: '当前没有可提前使用的下期额度',
    ...
    advanceEntitlementMonthlyCycle: '提前使用下期额度',
  ...
  payment: {
    ...
    withdrawalHint: 'The amount is reserved on submission and paid after approval.',
      ...
      availableCommission: '当前可提现总额（CNY）',
  ...
  referral: {
    home: '首页',
    accountCoolingDown: '收款账户冷却中，暂不可修改',
    accountEditableNow: '现在可修改',
    accountName: '收款人姓名',
    accountNextEditableAt: '可修改时间：{time}',
    accountSaved: '收款账户已保存',
    accountUpdated: '收款账户已更新',
    addNewAccount: '添加收款账户',
    alipayAccount: '支付宝账号',
    availableCommission: '当前可提现佣金',
    availableToWithdraw: '可提现额度',
    bankCardNo: '银行卡号',
    bankName: '开户银行',
    bindTime: '绑定时间',
    copyInviteLink: '复制邀请链接',
    dropQrHint: '拖拽图片到此处或点击选择',
    entryType: '流水类型',
    hasQrCode: '已绑定收款码',
    imageTooLarge: '图片大小不能超过 2MB',
    invalidImageType: '请选择 PNG、JPG 或 GIF 格式的图片',
    latestPaidAt: '最近付款',
    makeDefaultAccount: '设为默认收款方式',
    noPayoutAccountHint: '请先添加收款账户',
    notPaid: '尚未付款',
    orderCount: '订单数',
    payoutAccountsHint: '新增收款账户；修改已有账户需满足 7 天冷却期。',
    payoutMethod: '收款方式',
    processingCommission: '佣金处理中',
    qrCode: '收款二维码',
    qrUrlPlaceholder: '或粘贴图片链接 https://',
    selectPayoutAccount: '收款账户',
    submitWithdrawal: '确认申请提现',
    totalCommission: '累计佣金',
    totalCommissionAmount: '返佣总额',
    totalRecharge: '充值总额',
    updateAccount: '编辑收款账户',
    wechatAccount: '微信账号',
    wechatQrUrl: '微信收款码链接',
    withdrawAll: '全部提现',
    withdrawAmount: '提现金额',
    withdrawInvalid: '请填写有效金额并选择收款账户',
    withdrawRemark: '留言备注（选填）',
    withdrawalCreated: '提现申请已提交',
    withdrawalHint: '提交后锁定申请金额，审核通过后打款。',
    withdrawalNo: '提现单号',
    withdrawnCommission: '已提现佣金',
    title: '邀请有礼',
    description: '分享链接邀好友，充值成功享礼金。',
    enabled: '邀请有礼',
