    ...
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <!-- Built-in Menu Visibility -->
          <div class="card">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-dark-700"
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                {{ t("admin.settings.builtinMenus.title") }}
              </h2>
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ t("admin.settings.builtinMenus.description") }}
              </p>
            </div>
            <div class="space-y-4 p-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.builtinMenus.modelPricesUserVisible") }}
                  </label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.builtinMenus.modelPricesUserVisibleHint") }}
                  </p>
                </div>
                <Toggle v-model="form.model_prices_user_visible" />
              </div>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="space-y-4 p-6">
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="input-label mb-0">{{ t('admin.settings.referral.enableReferral') }}</label>
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.referral.enableReferralDesc') }}</p>
              </div>
            ...
            <template v-if="form.referral_enabled">
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.referral.allowManualInputDesc') }}</p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.referral.bindBeforeFirstPaidOnlyDesc') }}</p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.referral.withdrawEnabledDesc') }}</p>
                </div>
...
async function saveSettings() {
  ...
  try {
    ...
    wsOk = await saveWebSearchConfig();
