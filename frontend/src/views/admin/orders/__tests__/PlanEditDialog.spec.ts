...
const GroupBadgeStub = defineComponent({
  ...
  template: '<span data-testid="group-badge">{{ name }} | {{ platform }} | {{ rateMultiplier }}x</span>',
})
...
describe('PlanEditDialog', () => {
  ...
  it('allows composite subscription groups for payment plans', () => {
    ...
    const groupBadges = wrapper.findAll('[data-testid="group-badge"]').map(badge => badge.text())
